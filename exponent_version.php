...
if (!defined('EXPONENT_VERSION_MAJOR')) {
	...
	if (RELEASE != '%%RELEASE%%') {
		 ...
		 */
		define('EXPONENT_VERSION_MINOR','1');
		/* exdoc
		 ...
		 */
		define('EXPONENT_VERSION_ITERATION','11'); // only applies to betas, alphas, or release candidates
		/* exdoc
		 * This is the date that this version of Exponent was released.
		 */
		define('EXPONENT_VERSION_BUILDDATE','1473811261');
	} else {

...
if (!defined('EXPONENT_VERSION_MAJOR')) {
	...
	if (RELEASE != '%%RELEASE%%') {
		...
		/* exdoc
		 * This is the major version number of Exponent; the 2 in 2.4.7-beta3
		 */
		define('EXPONENT_VERSION_MAJOR','2');
		/* exdoc
		 * This is the minor version number of Exponent; the 4 in 2.4.7-beta3
		 */
		define('EXPONENT_VERSION_MINOR','4');
		/* exdoc
		 * This is the revision version number of Exponent; the 7 in 2.4.7-beta3
		 */
		...
		/* exdoc
		 * This number is bumped each time a distribution of a single version type is
		 ...
		 */
        define('EXPONENT_VERSION_BUILDDATE','1514833491');
	} else {

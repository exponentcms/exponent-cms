...
return array(
	...
	"This form allows you to register an Exponent installation as a Codebase, in order to deploy sites from it later.  Enter a descriptive name for the codebase, and the path to the root directory."=>"This form allows you to register an Exponent installation as a Codebase, in order to deploy sites from it later.  Enter a descriptive name for the codebase, and the path to the root directory.",

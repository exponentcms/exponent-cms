...
return array(
	...
	"Add New Event Date"=>"Add New Event Date",
	...
	"Add Title"=>"Add Title",
	"Add \'well\' type styling"=>"Add \'well\' type styling",
	"Add a"=>"Add a",
	...
	"Add a tip"=>"Add a tip",
	"Add additional dates to an existing event as you choose below."=>"Add additional dates to an existing event as you choose below.",
	...
	"Add form records imto search index to appear as search results"=>"Add form records imto search index to appear as search results",
	"Add more Dates"=>"Add more Dates",
	...
	"Additional Form Import/Export methods available in"=>"Additional Form Import/Export methods available in",
	...
	"Affects Inventory?"=>"Affects Inventory?",
	"After Adding an Item:"=>"After Adding an Item:",
	...
	"Allow single click form submission?"=>"Allow single click form submission?",
	...
	"Also used by Twitter, Pinterest, etc..."=>"Also used by Twitter, Pinterest, etc...",
	"Alt"=>"Alt",
	...
	"An error was encountered initializing payment method"=>"An error was encountered initializing payment method",
	...
	"Are you sure you want to delete this codebase and all sites deployed from it?"=>"Are you sure you want to delete this codebase and all sites deployed from it?",
	"Are you sure you want to delete this comment?"=>"Are you sure you want to delete this comment?",
	"Are you sure you want to delete this deployed site?"=>"Are you sure you want to delete this deployed site?",
	...
	"Are you sure you want to delete this tip?"=>"Are you sure you want to delete this tip?",
	...
	"Assign group permissions on this Multi-Site Manager"=>"Assign group permissions on this Multi-Site Manager",
	...
	"Assign user permissions on this Multi-Site Manager"=>"Assign user permissions on this Multi-Site Manager",
	"Assigned"=>"Assigned",
	...
	"Automatically Play First Media File"=>"Automatically Play First Media File",
	"Automatically Send E-Alerts"=>"Automatically Send E-Alerts",
	"Automatically added to end of blog posts if so configured with that blog module"=>"Automatically added to end of blog posts if so configured with that blog module",
	"Autoplay"=>"Autoplay",
	...
	"Avatar Image (using current user e-mail)"=>"Avatar Image (using current user e-mail)",
	"Back"=>"Back",
	...
	"Bad Raw Trackers and"=>"Bad Raw Trackers and",
	"Bad Redirects"=>"Bad Redirects",
	"Bad Search Queries"=>"Bad Search Queries",
	"Bad Session Tickets"=>"Bad Session Tickets",
	...
	"Because of some of the functions that Exponent uses, versions of PHP prior to 5.6.0 are not suitable.  Most functions that are supported in later versions have workarounds, but there are a few major bugs, and functions that can\'t be re-implemented in PHP prior to 5.6.0."=>"Because of some of the functions that Exponent uses, versions of PHP prior to 5.6.0 are not suitable.  Most functions that are supported in later versions have workarounds, but there are a few major bugs, and functions that can\'t be re-implemented in PHP prior to 5.6.0.",
	...
	"Body"=>"Body",
	"Body - text area"=>"Body - text area",
	"Body Content"=>"Body Content",
	"Body Text"=>"Body Text",
	"Boot Users"=>"Boot Users",
	"Bootstrap 4 beta theme files removed."=>"Bootstrap 4 beta theme files removed.",
	"Bootstrap-5 beta theme files removed."=>"Bootstrap-5 beta theme files removed.",
	...
	"Building a Sitemap"=>"Building a Sitemap",
	...
	"Category"=>"Category",
	"Category - drop down list"=>"Category - drop down list",
	...
	"Children"=>"Children",
	"Choose Modules and Themes"=>"Choose Modules and Themes",
	...
	"Clean Data Issues"=>"Clean Data Issues",
	...
	"Click to View PHP Info"=>"Click to View PHP Info",
	...
	"Content Editor Settings"=>"Content Editor Settings",
	...
	"Control Label Style"=>"Control Label Style",
	...
	"Create a New Form"=>"Create a New Form",
	"Create a New Page Redirection"=>"Create a New Page Redirection",
	...
	"Custom E-Mail and Single Item View Template"=>"Custom E-Mail and Single Item View Template",
	...
	"Custom Single Record View Configuration"=>"Custom Single Record View Configuration",
	...
	"Customers"=>"Customers",
	"Customize CKEditor and TinyMCE Usage"=>"Customize CKEditor and TinyMCE Usage",
	...
	"DOMPDF v3 is an optional package.  To obtain it, you must first download our customized version of the library"=>"DOMPDF v3 is an optional package.  To obtain it, you must first download our customized version of the library",
	"Daily"=>"Daily",
	...
	"Dates"=>"Dates",
	"Day"=>"Day",
	"Deactivate Deployed Site"=>"Deactivate Deployed Site",
	"December"=>"December",
	"Default"=>"Default",
	...
	"Default time zone for this site CAUTION: Changes may affect calendars and other features using date functions."=>"Default time zone for this site CAUTION: Changes may affect calendars and other features using date functions.",
	...
	"Delete Page Redirection Log"=>"Delete Page Redirection Log",
	...
	"Delete this redirection?"=>"Delete this redirection?",
	...
	"Deploy New Site"=>"Deploy New Site",
	...
	"Details"=>"Details",
	"Details concerning additional order information comments at checkout"=>"Details concerning additional order information comments at checkout",
	...
	"Display Redirected Pages"=>"Display Redirected Pages",
	...
	"Display category description in place of sub-categories"=>"Display category description in place of sub-categories",
	...
	"Displays Shopping Cart"=>"Displays Shopping Cart",
	...
	"Displays and manages images and slideshows."=>"Displays and manages images and slideshows.",
	...
	"Dompdf v3 is NOT installed!"=>"Dompdf v3 is NOT installed!",
	"Dompdf v3 is installed!"=>"Dompdf v3 is installed!",
	...
	"Edit Page Redirection"=>"Edit Page Redirection",
	...
	"Editing Page Redirection"=>"Editing Page Redirection",
	...
	"Embedded Content Modules"=>"Embedded Content Modules",
	...
	"Enable CDN for loading major libraries"=>"Enable CDN for loading major libraries",
	...
	"Enable this setting to skip form entry confirmation"=>"Enable this setting to skip form entry confirmation",
	"Enable/Disable Options"=>"Enable/Disable Options",
	"Enabled"=>"Enabled",
	"Enabling this payment option will allow an Admin to bypass normal payment processing at checkout. It might allow payment methods after the order is processed, such as cash, check, pay in store, or manually process via credit card."=>"Enabling this payment option will allow an Admin to bypass normal payment processing at checkout. It might allow payment methods after the order is processed, such as cash, check, pay in store, or manually process via credit card.",
	...
	"Enter \'0\' to keep full log"=>"Enter \'0\' to keep full log",
	...
	"Enter the dollar amount to discount the shipping cost."=>"Enter the dollar amount to discount the shipping cost.",
	"Enter the dollar amount to discount the total order."=>"Enter the dollar amount to discount the total order.",
	...
	"Enter the site domain name to prevent Host Header Injections. 0 to disable check"=>"Enter the site domain name to prevent Host Header Injections. 0 to disable check",
	...
	"Exponent CMS Database"=>"Exponent CMS Database",
	...
	"Export"=>"Export",
	"Export ALL Columns in CSV?"=>"Export ALL Columns in CSV?",
	...
	"Facebook App ID is needed for Status Posting and Like Buttons"=>"Facebook App ID is needed for Status Posting and Like Buttons",
	...
	"Failed, PHP XML not enabled"=>"Failed, PHP XML not enabled",
	"Failed, PHP curl extension needed"=>"Failed, PHP curl extension needed",
	"Failed, PHP zlib not enabled"=>"Failed, PHP zlib not enabled",
	"Fax"=>"Fax",
	...
	"Form records were corrected."=>"Form records were corrected.",
	"Form save data tables were corrected."=>"Form save data tables were corrected.",
	"Form search records were updated."=>"Form search records were updated.",
	...
	"Forms controls had their type updated."=>"Forms controls had their type updated.",
	...
	"Full Width when Labels on Side?"=>"Full Width when Labels on Side?",
	...
	"Generic Generated page"=>"Generic Generated page",
	...
	"Get a MapQuest Maps API Key"=>"Get a MapQuest Maps API Key",
	...
	"Goes to a Specific page (below)"=>"Goes to a Specific page (below)",
	...
	"HTML2PDF v5 is NOT installed!"=>"HTML2PDF v5 is NOT installed!",
	...
	"HTML2PDF v5 is installed!"=>"HTML2PDF v5 is installed!",
	"HTTP Status Code"=>"HTTP Status Code",
	"Handle Page Not Found Redirection?"=>"Handle Page Not Found Redirection?",
	...
	"Here, you can choose which modules and themes you want to make available to the shared core site."=>"Here, you can choose which modules and themes you want to make available to the shared core site.",
	...
	"Hide sub-categories if category description avaiable?"=>"Hide sub-categories if category description avaiable?",
	...
	"However, in some cases you may want to handle those requests by redirecting the user to another page."=>"However, in some cases you may want to handle those requests by redirecting the user to another page.",
	...
	"Install Selected Addons"=>"Install Selected Addons",
	...
	"Install Tables Script Error"=>"Install Tables Script Error",
	"Install new Extension"=>"Install new Extension",
	...
	"It will return once our technicians have completed repairs."=>"It will return once our technicians have completed repairs.",
	"It worked!"=>"It worked!",
	"Item"=>"Item",
	...
	"Like"=>"Like",
	"Limit"=>"Limit",
	"Limit Records to"=>"Limit Records to",
	...
	"MPDF v8.2 is an optional package, but the preferred generator.  To obtain it, you must first download the customized version of the library"=>"MPDF v8.2 is an optional package, but the preferred generator.  To obtain it, you must first download the customized version of the library",
	...
	"Manage Site RSS Feeds"=>"Manage Site RSS Feeds",
	...
	"Maximum Redirection Log Age (in days)"=>"Maximum Redirection Log Age (in days)",
	...
	"Military"=>"Military",
	"Minify"=>"Minify",
	"Minify .less/.scss compiled style-sheets?"=>"Minify .less/.scss compiled style-sheets?",
	...
	"Moved Temporarly (302)"=>"Moved Temporarly (302)",
	...
	"New Page Redirection"=>"New Page Redirection",
	...
	"No FileInfo Support, PHP finfo extension needed"=>"No FileInfo Support, PHP finfo extension needed",
	...
	"No GD Support, PHP gd extension needed"=>"No GD Support, PHP gd extension needed",
	...
	"No Zip file support for installing Extensions, PHP zip extension needed"=>"No Zip file support for installing Extensions, PHP zip extension needed",
	...
	"No pages redirected yet"=>"No pages redirected yet",
	...
	"No records found"=>"No records found",
	"No redirections found"=>"No redirections found",
	...
	"No sites have been deployed from this codebase."=>"No sites have been deployed from this codebase.",
	...
	"Normally requests for non-existent pages result in a Not Found response."=>"Normally requests for non-existent pages result in a Not Found response.",
	...
	"Note"=>"Note",
	"Note Body"=>"Note Body",
	"Note there are different keys for different types of reCAPTCHA (v2 checkbox, v2 invisible, or v3), they are NOT interchangable!"=>"Note there are different keys for different types of reCAPTCHA (v2 checkbox, v2 invisible, or v3), they are NOT interchangable!",
	...
	"Note: Which modules and themes are available to this site is decided on the next page."=>"Note: Which modules and themes are available to this site is decided on the next page.",
	"Note: multiple day events are not supported."=>"Note: multiple day events are not supported.",
	"Note: the state upcharge rate will be added to the country upcharge rate!"=>"Note: the state upcharge rate will be added to the country upcharge rate!",
	...
	"Only use the SMTP Username address above for outgoing emails"=>"Only use the SMTP Username address above for outgoing emails",
	...
	"Optional syntax highlighting editor"=>"Optional syntax highlighting editor",
	"Optional syntax highlighting editor theme"=>"Optional syntax highlighting editor theme",
	"Optionally (to get better results)"=>"Optionally (to get better results)",
	"Optionally Limit site search results to eCommerce related items"=>"Optionally Limit site search results to eCommerce related items",
	...
	"Our website is currently down for maintenance."=>"Our website is currently down for maintenance.",
	...
	"PHP Zip extension not loaded"=>"PHP Zip extension not loaded",
	...
	"Page Redirection Log"=>"Page Redirection Log",
	...
	"Please enter the row within the csv file to start at. The start row is for files that have column headers, or if you just want to skip records in the csv file."=>"Please enter the row within the csv file to start at. The start row is for files that have column headers, or if you just want to skip records in the csv file.",
	...
	"Portfoio"=>"Portfoio",
	"Portfolio"=>"Portfolio",
	"Portfolio Piece Entry"=>"Portfolio Piece Entry",
	...
	"Removing"=>"Removing",
	"Removing a content page moves it to the Standalone Page Manager, removing it from the Site Hierarchy. If there are any sub-pages to this section, those will also be moved"=>"Removing a content page moves it to the Standalone Page Manager, removing it from the Site Hierarchy. If there are any sub-pages to this section, those will also be moved",
	"Removing an internal alias page or external link page permanently removes it from the system."=>"Removing an internal alias page or external link page permanently removes it from the system.",
	...
	"Returns to Product page"=>"Returns to Product page",
	"Retweet"=>"Retweet",
	"Retweeted by Me"=>"Retweeted by Me",
	"Retweets of Me"=>"Retweets of Me",
	"Retype Password"=>"Retype Password",
	"Reveal Hidden Alerts"=>"Reveal Hidden Alerts",
	...
	"Select a page to fill in the URL field"=>"Select a page to fill in the URL field",
	"Select an Action"=>"Select an Action",
	"Select an Anti-Spam Control"=>"Select an Anti-Spam Control",
	...
	"Select specific page to display  when a Customer clicks on \'Store\' breadcrumb"=>"Select specific page to display  when a Customer clicks on \'Store\' breadcrumb",
	"Select specific page to display after adding a new item to the Shopping Cart"=>"Select specific page to display after adding a new item to the Shopping Cart",
	...
	"Select the options below to change the details in"=>"Select the options below to change the details in",
	...
	"Server Temp File Error."=>"Server Temp File Error.",
	...
	"Since this is a recurring event, you can decide to delete just this instance of it, or all instances, below."=>"Since this is a recurring event, you can decide to delete just this instance of it, or all instances, below.",
	...
	"Some SMTP Servers only allow sending emails from addresses which exist on themselves"=>"Some SMTP Servers only allow sending emails from addresses which exist on themselves",
	...
	"Specific Page after Adding an Item"=>"Specific Page after Adding an Item",
	"Specific Page for Store Home"=>"Specific Page for Store Home",
	"Specific page (below)"=>"Specific page (below)",
	"Speed"=>"Speed",
	...
	"Store Home Location:"=>"Store Home Location:",
	...
	"Syntax Highlighting Editor Theme"=>"Syntax Highlighting Editor Theme",
	"System"=>"System",
	...
	"Temporary Redirect (307)"=>"Temporary Redirect (307)",
	"Term"=>"Term",
	...
	"The PHP Zip extension is used for archive support, which Exponent uses for uncompressing Zip archives."=>"The PHP Zip extension is used for archive support, which Exponent uses for uncompressing Zip archives.",
	...
	"The following messages can be added to the module."=>"The following messages can be added to the module.",
	...
	"The session variable value was set"=>"The session variable value was set",
	...
	"There Are No Fixes or Patches Available for this Version"=>"There Are No Fixes or Patches Available for this Version",
	...
	"These products are NOT assigned to an end-node category and therefore will NOT appear in any listing."=>"These products are NOT assigned to an end-node category and therefore will NOT appear in any listing.",
	...
	"They MUST be asssgned to a store category which doesn\'t have sub-categories in order to appear in any listing."=>"They MUST be asssgned to a store category which doesn\'t have sub-categories in order to appear in any listing.",
	...
	"This action does not exist"=>"This action does not exist",
	...
	"This form allows you to register an Exponent installation as a Codebase, in order to deploy sites from it later.  Enter a descriptive name for the codebase, and the path to the root directory of the server."=>"This form allows you to register an Exponent installation as a Codebase, in order to deploy sites from it later.  Enter a descriptive name for the codebase, and the path to the root directory of the server.",
	...
	"This site has been deactivated"=>"This site has been deactivated",
	...
	"This will simplify and speed up the permission system to see all users as either a basic user or an admin. Any existing User and Group Permissions will not apply."=>"This will simplify and speed up the permission system to see all users as either a basic user or an admin. Any existing User and Group Permissions will not apply.",
	"This would especially be desired if a page is renamed."=>"This would especially be desired if a page is renamed.",
	"Thumb"=>"Thumb",
	"Thumbnail"=>"Thumbnail",
	...
	"To deploy a new site, choose a codebase, and enter the file system path for the new site."=>"To deploy a new site, choose a codebase, and enter the file system path for the new site.",
	...
	"Use Bootstrap Icons instead of Font Awesome"=>"Use Bootstrap Icons instead of Font Awesome",
	...
	"Use Simple Permissions?"=>"Use Simple Permissions?",
	...
	"User/Customer Sessions"=>"User/Customer Sessions",
	"Username"=>"Username",
	...
	"View Other Tips"=>"View Other Tips",
	...
	"View all posts by date"=>"View all posts by date",
	...
	"Warning"=>"Warning",
	"Warning! This command will REPLACE the existing"=>"Warning! This command will REPLACE the existing",
	...
	"What page to display after adding a new item to the Shopping Cart"=>"What page to display after adding a new item to the Shopping Cart",
	"What page to display when a Customer clicks on \'Store\' breadcrumb"=>"What page to display when a Customer clicks on \'Store\' breadcrumb",
	...
	"When you deactivate a deployed site, a page is put up to catch visitors and notify them that the site has been taken down.  Choose the template you wish to use, and enter some explanation of why the deployed site is being deactivated (this will be shown to visitors)."=>"When you deactivate a deployed site, a page is put up to catch visitors and notify them that the site has been taken down.  Choose the template you wish to use, and enter some explanation of why the deployed site is being deactivated (this will be shown to visitors).",
	...
	"Will also export any files, categories, comments, or tags attached to item"=>"Will also export any files, categories, comments, or tags attached to item",
	...
	"You are adding a new sub page to."=>"You are adding a new sub page to.",
	...
	"You do not have the proper permissions to edit this address"=>"You do not have the proper permissions to edit this address",
	"You do not have the proper permissions to edit this user"=>"You do not have the proper permissions to edit this user",
	"You do not have the proper permissions to view this record"=>"You do not have the proper permissions to view this record",
	...
	"and then extract it on your server into the \'external\' folder and rename the folder to \'MPDF57\'."=>"and then extract it on your server into the \'external\' folder and rename the folder to \'MPDF57\'.",
	"and then extract it on your server into the \'external\' folder and rename the folder to \'mpdf61\'."=>"and then extract it on your server into the \'external\' folder and rename the folder to \'mpdf61\'.",
	...
	"form controls were reranked."=>"form controls were reranked.",
	"form records"=>"form records",
	"from"=>"from",
	"from cart"=>"from cart",
	...
	"mPDF v7"=>"mPDF v7",
	"mPDF v7 is NOT installed!"=>"mPDF v7 is NOT installed!",
	"mPDF v7 is installed!"=>"mPDF v7 is installed!",
	"mPDF v8"=>"mPDF v8",
	"mPDF v8 is NOT installed!"=>"mPDF v8 is NOT installed!",
	"mPDF v8 is installed!"=>"mPDF v8 is installed!",
	"mPDF v8.2"=>"mPDF v8.2",
	"mPDF v8.2 is NOT installed!"=>"mPDF v8.2 is NOT installed!",
	"mPDF v8.2 is installed!"=>"mPDF v8.2 is installed!",
	"mail server settings"=>"mail server settings",
	...
	"old posts had their created date set."=>"old posts had their created date set.",
	"on"=>"on",
	"on Google+"=>"on Google+",

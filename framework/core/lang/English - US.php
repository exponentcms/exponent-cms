...
return array(
	...
	"Add Note"=>"Add Note",
	"Add Notes"=>"Add Notes",
	"Add Notes,Delete,Apply Discount,Refund"=>"Add Notes,Delete,Apply Discount,Refund",
	...
	"All Orders,Only Open Orders, Only Closed Orders"=>"All Orders,Only Open Orders, Only Closed Orders",
	...
	"Are you sure you want to delete this speed?"=>"Are you sure you want to delete this speed?",
	...
	"Authorize and Capture, Authorize Only"=>"Authorize and Capture, Authorize Only",
	...
	"Bad Queries Report"=>"Bad Queries Report",
	...
	"Business"=>"Business",
	"Business,Military,Residential"=>"Business,Military,Residential",
	"Button Color"=>"Button Color",
	"Button Settings"=>"Button Settings",
	"Button Size"=>"Button Size",
	"By Billing"=>"By Billing",
	"By Billing,or Shipping State:"=>"By Billing,or Shipping State:",
	"By Billing,or Shipping Zipcode:"=>"By Billing,or Shipping Zipcode:",
	"By Date"=>"By Date",
	"By Day"=>"By Day",
	...
	"Configure Calendar2 Module"=>"Configure Calendar2 Module",
	...
	"Container"=>"Container",
	"Containg A Product Name Like"=>"Containg A Product Name Like",
	"Containg A SKU Like"=>"Containg A SKU Like",
	...
	"Date Added, Date Added Descending, Date Updated, Date Updated Descending, Date Published, Date Published Descending"=>"Date Added, Date Added Descending, Date Updated, Date Updated Descending, Date Published, Date Published Descending",
	"Date Added, Date Added Descending, Date Updated, Date Updated Descending, Date Published, Date Published Descending, Number Downloads, Number Downloads Descending, Alphabetical, Reverse Alphabetical, Order Manually"=>"Date Added, Date Added Descending, Date Updated, Date Updated Descending, Date Published, Date Published Descending, Number Downloads, Number Downloads Descending, Alphabetical, Reverse Alphabetical, Order Manually",
	...
	"Deleting a page moves it to the Standalone Page Manager, removing it from the Site Hierarchy. If there are any sub-pages to this section, those will also be moved"=>"Deleting a page moves it to the Standalone Page Manager, removing it from the Site Hierarchy. If there are any sub-pages to this section, those will also be moved",
	...
	"E-Alerts Subscription Settings"=>"E-Alerts Subscription Settings",
	...
	"Ecommerce Billing Controller"=>"Ecommerce Billing Controller",
	"Ecommerce Configuration Manager"=>"Ecommerce Configuration Manager",
	"Ecommerce Order Manager"=>"Ecommerce Order Manager",
	"Ecommerce Order Types"=>"Ecommerce Order Types",
	"Ecommerce Product Statuses"=>"Ecommerce Product Statuses",
	"Ecommerce Purchase Order Manager"=>"Ecommerce Purchase Order Manager",
	"Ecommerce Sales Reps"=>"Ecommerce Sales Reps",
	"Ecommerce Shipping Controller"=>"Ecommerce Shipping Controller",
	"Ecommerce Shopping Cart"=>"Ecommerce Shopping Cart",
	"Ecommerce Status Codes"=>"Ecommerce Status Codes",
	"Ecommerce Store Configuration"=>"Ecommerce Store Configuration",
	"Edit"=>"Edit",
	...
	"Enable Test Mode?"=>"Enable Test Mode?",
	"Enable Test Mode? You must be logged in to"=>"Enable Test Mode? You must be logged in to",
	...
	"Equal to"=>"Equal to",
	"Equal to,Less than,Greater than"=>"Equal to,Less than,Greater than",
	...
	"Event Registration - Upcomming Events"=>"Event Registration - Upcomming Events",
	...
	"Home,User,Friends,Mentions,Public"=>"Home,User,Friends,Mentions,Public",
	...
	"Import addressess from other sources"=>"Import addressess from other sources",
	...
	"Last 24 hours, Last 48 hours, Jurassic Period and prior"=>"Last 24 hours, Last 48 hours, Jurassic Period and prior",
	...
	"Manage Ecommerce Order Types"=>"Manage Ecommerce Order Types",
	"Manage Ecommerce Product Statuses"=>"Manage Ecommerce Product Statuses",
	"Manage Ecommerce Sales Reps"=>"Manage Ecommerce Sales Reps",
	"Manage Ecommerce status codes"=>"Manage Ecommerce status codes",
	...
	"Manage tax classes for your Ecommerce store"=>"Manage tax classes for your Ecommerce store",
	...
	"Minimum Gift Card Puchase"=>"Minimum Gift Card Puchase",
	...
	"No Float"=>"No Float",
	"No Float,Left,Right"=>"No Float,Left,Right",
	...
	"No category"=>"No category",
	"No causes have been setup to donate to."=>"No causes have been setup to donate to.",
	...
	"Number of Top Search Queries"=>"Number of Top Search Queries",
	...
	"Pay with Worldpay"=>"Pay with Worldpay",
	"PayPal"=>"PayPal",
	...
	"Puts text on your webpages"=>"Puts text on your webpages",
	"QTY"=>"QTY",
	"Qty"=>"Qty",
	"Quantity"=>"Quantity",
	...
	"Send a notication that a new order was received?"=>"Send a notication that a new order was received?",
	...
	"Show uncategoried products"=>"Show uncategoried products",
	...
	"Single Image,Image with Swatches"=>"Single Image,Image with Swatches",
	...
	"Standard Box Heigth (inches)"=>"Standard Box Heigth (inches)",
	...
	"The last Month,The Last 6 months,The Last Year,All Time"=>"The last Month,The Last 6 months,The Last Year,All Time",
	...
	"This module is for manageing categories in your store."=>"This module is for manageing categories in your store.",
	"This module is for manageing ratings on records"=>"This module is for manageing ratings on records",
	"This module is for manageing your Nested Nodes"=>"This module is for manageing your Nested Nodes",
	"This module is for managing your categories"=>"This module is for managing your categories",
	"This module is for managing your tags"=>"This module is for managing your tags",
	...
	"This module will allow your users to signup for email alerts on a module by module basis."=>"This module will allow your users to signup for email alerts on a module by module basis.",
	...
	"Title"=>"Title",
	"Title for this iCal feed"=>"Title for this iCal feed",
	...
	"Unavailable if out of stock.,Available but shown as backordered if out of stock.,Always available even if out of stock.,Show as \'Call for Price\'."=>"Unavailable if out of stock.,Available but shown as backordered if out of stock.,Always available even if out of stock.,Show as \'Call for Price\'.",
	...
	"Update existing address, Save as new address"=>"Update existing address, Save as new address",
	...
	"Use this module to configure your Ecommerce store"=>"Use this module to configure your Ecommerce store",
	...
	"Use this module to display products and categories of you Ecommerce store"=>"Use this module to display products and categories of you Ecommerce store",
	...
	"View the Ecommerce Dashboard"=>"View the Ecommerce Dashboard",
	...
	"Your new password for"=>"Your new password for",
	...
	"t show page links"=>"t show page links",
	"theme"=>"theme",
	"this"=>"this",
	"to"=>"to",

...
return array(
	...
	"You are subscribed to receive email alerts for the following topics"=>"You are subscribed to receive email alerts for the following topics",
	...
	"obsolete files were removed."=>"obsolete files were removed.",
	"of"=>"of",

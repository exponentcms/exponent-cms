...
return array(
	...
	"Because of some of the functions that Exponent uses, versions of PHP prior to 7.4.0 are not suitable.  Most functions that are supported in later versions have workarounds, but there are a few major bugs, and functions that can\'t be re-implemented in PHP prior to 7.4.0."=>"Because of some of the functions that Exponent uses, versions of PHP prior to 7.4.0 are not suitable.  Most functions that are supported in later versions have workarounds, but there are a few major bugs, and functions that can\'t be re-implemented in PHP prior to 7.4.0.",
	...
	"This version of ExponentCMS requires PHP 7.4.0 or higher. You are running PHP"=>"This version of ExponentCMS requires PHP 7.4.0 or higher. You are running PHP",

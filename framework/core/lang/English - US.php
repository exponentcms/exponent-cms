...
return array(
	...
	"Date"=>"Date",
	"Date Added, Order Manually"=>"Date Added, Order Manually",
	...
	"GBP (Pounds Sterling),USD (US Dollar)"=>"GBP (Pounds Sterling),USD (US Dollar)",
	...
	"Newest First, Oldest First"=>"Newest First, Oldest First",
	...
	"Top"=>"Top",
	"Top and Bottom,Top Only,Bottom Only,Don\'t show page links"=>"Top and Bottom,Top Only,Bottom Only,Don\'t show page links",
...
feature to set the password to one of your choosing.",
	...
	"t pass the ID of a form, you need to specify both a module/controller AND and a cresponding action."=>"t pass the ID of a form, you need to specify both a module/controller AND and a cresponding action.",
	"test"=>"test",
	"theme"=>"theme",
	"this"=>"this",

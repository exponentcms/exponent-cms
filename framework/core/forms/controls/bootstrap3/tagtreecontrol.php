    ...
    function toHTML($label, $name) {
        ...
        if ($this->menu == "true") {
            ...
            if ($framework == 'bootstrap3') {
                ...
                $html .= '<a class="btn btn-default '.$btn_size.'" href="#" id="expandall"><i class="fa fa-resize-full '.$icon_size.'"></i> ' . gt('Expand All') . '</a> ';
                $html .= '<a class="btn btn-default '.$btn_size.'" href="#" id="collapseall"><i class="fa fa-resize-small '.$icon_size.'"></i> ' . gt('Collapse All') . '</a>';
            } else {

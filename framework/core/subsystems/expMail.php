...
class expMail {
	...
	//this is the mail transporterm like exim, SMTP, whatever, that is setup in the contructor
	private $mailer = null;
	...
	private $postcalldata = null;
	 ...
	 /**
     *  __construct() - This function contructs the message to be send in this object, filling it out with connection information based on the site config.
	 *	    
	 *	
     * 
	 ...
	 *  
	 * 	@todo Add from_name support for quicksend
	 *  @todo Add support to send method for pulling subject and to from Site config so that if none are specified, a quicksend will not require any options.
	 *  
     ...
     */		
 	...
 	public function quickSend($params=array()) {
 	    ...
 	    if (empty($params['to']) || empty($params['subject']) || empty($params['html_message'])) {
 			return false;
 		}
 	...
 	public function send () {
 		...
 		//the from address is ususally set as the system default.
      ...
      *  
      *  This should probably be taken out as it look like a failed attempt to use the oldschool AntiFlood plugin
 	...
 	public function addHeaders($headers) {
 	 ...
 	 /**
      *  addHTML() - This function is similar to setHTMLBody except that it includes the HTML in the message body rather than sets it as defualt. Many 

...
//	usort($actions,"exponent_sorting_byRankAscending");
	...
	foreach ($actions as $action) {
		if (is_readable(BASE."framework/core/subsystems-1/workflow/actions/".$action->method.".php")) {
			include_once(BASE."framework/core/subsystems-1/workflow/actions/".$action->method.".php");
		}
	}
}
...
function exponent_workflow_getAvailableActions() {
	$actions = array();
	if (is_readable(BASE."framework/core/subsystems-1/workflow/actions")) {
		$dh = opendir(BASE."framework/core/subsystems-1/workflow/actions");
		while (($file = readdir($dh)) !== false) {
			if (is_readable(BASE."framework/core/subsystems-1/workflow/actions/$file") && substr($file,-4,4) == ".php") {

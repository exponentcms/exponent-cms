var EXPONENT.attFiles =  function(name) {
    ...
    YAHOO.util.Event.on('addfiles-'+o.name, 'click', function (e){
        ...
        win = window.open(eXp.URL_FULL+'modules/filemanagermodule/actions/manager.php?update=".$name."', 'IMAGE_BROWSER','left=20,top=20,scrollbars=yes,width=800,height=500,toolbar=0,resizable=0,status=0');
        if (!win) {

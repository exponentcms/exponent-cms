...
<div id="textmodule-{$name}" class="module text showall showall-inline">
        ...
        {permissions}
            <div class="module-actions">
                {if $permissions.create}
                    <a class="add-body btn btn-success {$btn_size}" href="{link action=add}" title="{'Add more text at bottom'|gettext}"><i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-plus-circle{else}fas fa-plus-circle{/if} {$icon_size}"></i> {'Add more text at bottom'|gettext}</a>
                {/if}
                ...
                {permissions}
                    <div class="item-actions">
                        ...
                        {if $permissions.delete || ($permissions.create && $item->poster == $user->id)}
                            <a class="delete-item btn btn-danger {$btn_size}" href="{link action=delete}" title="{'Delete this text item'|gettext}"><i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-x-circle{else}fas fa-times-circle{/if} {$icon_size}"></i> {'Delete'|gettext}</a>
                        {/if}
                        {if $permissions.edit || ($permissions.create && $item->poster == $user->id)}
                            {if $item->title}
                                <a class="delete-title btn btn-danger {$btn_size}" id="deletetitle-{$item->id}" href="#" title="{'Delete Title'|gettext}"><i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-x-circle{else}fas fa-times-circle{/if} {$icon_size}"></i> {'Delete Title'|gettext}</a>
                            {else}
                                <a class="add-title btn btn-success {$btn_size}" id="addtitle-{$item->id}" href="#" title="{'Add Title'|gettext}"><i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-plus-circle{else}fas fa-plus-circle{/if} {$icon_size}"></i> {'Add Title'|gettext}</a>
                            {/if}
                        {/if}
    ...
    {permissions}
        <div class="module-actions">
            {if $permissions.create}
                <a class="add-body btn btn-success {$btn_size}" href="{link action=add}" title="{'Add more text here'|gettext}"><i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-file-arrow-down{else}fas fa-fw fa-arrow-down{/if}fas fa-plus-circle {$icon_size}"></i> {'Add more text here'|gettext}</a>
            {/if}
        </div>
    {/permissions}
</div>
...
{if $inline && !$preview}
    ...
    {script unique=$name jquery="bootbox.all" bootstrap="modal"}
    {literal}
            ...
            $.ajax({
                ...
                success:function(msg) {
                    if (msg.replyCode == '200') {
                        ...
                        newItem += '<a class="btn btn-secondary {/literal}{$btn_size}{literal}" title="{/literal}{'Edit this text item'|gettext}{literal}" href="' + EXPONENT.PATH_RELATIVE + 'text/edit/id/' + data.id + '/src/' + src + '"><i class="{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-pencil-square{else}fas fa-edit{/if} {$icon_size}{literal}"></i> {/literal}{'Edit'|gettext}{literal}</a>';
                        newItem += '<a class="delete-item btn btn-danger {/literal}{$btn_size}{literal}" title="{/literal}{'Delete'|gettext}{literal}" href="' + EXPONENT.PATH_RELATIVE + 'text/delete/id/' + data.id + '/src/' + src + '"><i class="{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-x-circle{else}fas fa-times-circle{/if} {$icon_size}{literal}"></i> {/literal}{'Delete'|gettext}{literal}</a>';
                        newItem +='<a class="delete-title btn btn-danger {/literal}{$btn_size}{literal}" id="deletetitle-' + data.id + '" href="#" title="{/literal}{'Delete Title'|gettext}{literal}"><i class="{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-x-circle{else}fas fa-times-circle{/if} {$icon_size}{literal}"></i> {/literal}{'Delete Title'|gettext}{literal}</a></div>';
            ...
            $.ajax({
                ...
                success: function(msg) {
                    if (msg.replyCode == '200') {
                        ...
                        startEditor($('#title-' + data.id)[0]);
                        chgItem ='<a class="delete-title btn btn-danger {/literal}{$btn_size}{literal}" id="deletetitle-' + data.id + '" href="#" title="{/literal}{'Delete Title'|gettext}{literal}"><i class="{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-x-circle{else}fas fa-times-circle{/if} {$icon_size}{literal}"></i> {/literal}{'Delete Title'|gettext}{literal}</a>';
                ...
                $.ajax({
                    ...
                    success: function(msg) {
                        if (msg.replyCode == '200') {
                            ...
                            chgItem ='<a class="add-title btn btn-success {/literal}{$btn_size}{literal}" id="addtitle-' + data.id + '" href="#" title="{/literal}{'Add Title'|gettext}{literal}"><i class="{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-x-circle{else}fas fa-times-circle{/if}{$icon_size}{literal}"></i> {/literal}{'Add Title'|gettext}{literal}</a>';

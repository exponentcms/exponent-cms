...
{control type=dropdown name=order label="Sort By"|gettext items="Date Added, Date Added Descending, Date Updated, Date Updated Descending, Date Published, Date Published Descending"|gettextlist values="created_at,created_at DESC,edited_at,edited_at DESC,publish,publish DESC" value=$config.order|default:'publish DESC'}

...
<head>
    ...
    {/css}
    {css unique="newui" link="`$smarty.const.PATH_RELATIVE`external/bootstrap5/css/bootstrap.css"}

    {/css}
    {css unique="fontawesome" link="`$smarty.const.PATH_RELATIVE`external/font-awesome6/css/fontawesome.css"}

 ...
 *}
	...
	<p class="caption">
		...
		<strong><span class="hidden-xs">{$time|format_date:"%A, %B %e, %Y"}</span><span class="visible-xs-inline">{$time|format_date:"%a"}</span></strong>&#160;&#160;{printer_friendly_link view='showall_Day' text=''|gettext}{export_pdf_link view='showall_Day' text=''|gettext}</a><span class="hidden-xs">&#160;&#160;&#160;</span>&#160;&raquo;&#160;</a><span class="hidden-xs">&#160;</span>

...
YUI(EXPONENT.YUI3_CONFIG).use('*',function(Y){
    ...
    var monthcal_{/literal}{$name}{literal} = Y.one('#week-{/literal}{$name}{literal}');
...
//        useShim:true
        ...
        {if $smarty.const.AJAX_PAGING}
            {literal}
                ...
                monthcal_{/literal}{$name}{literal}.setContent(Y.Node.create('{/literal}{loading title="Loading Week"|gettext}{literal}'));
            {/literal}
        {else}

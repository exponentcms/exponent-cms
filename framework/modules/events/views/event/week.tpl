 ...
 *}
	...
	<p class="caption">
        ...
        <strong><span class="hidden-xs">{'Week of'|gettext} {$time|format_date:"%B %e, %Y"}</span><span class="visible-xs-inline">{$time|format_date:"%b %e, %Y"}</span></strong><span class="hidden-xs">&#160;</span>&#160;{printer_friendly_link view='showall_Week' text=''|gettext}{export_pdf_link view='showall_Week' text=''|gettext}<span class="hidden-xs">&#160;&#160;&#160;</span>&#160;&raquo;&#160;<span class="hidden-xs">&#160;</span>

        ...
        <div id="{$config}" class="yui-navset exp-skin-tabview hide">
            ...
            <div class="yui-content">
                ...
                <div id="tab6">
                    ...
                    {control type="dropdown" name="sc[SITE_FILE_MANAGER]" label="File Manager"|gettext items="Traditional,elFinder" values="picker,elfinder" default=$smarty.const.SITE_FILE_MANAGER}

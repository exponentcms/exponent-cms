        ...
        <div id="demo" class="yui-navset">
            ...
            <div class="yui-content">
                ...
                <div id="tab4">
                    ...
                    {control type="text" name="sc[COMMENTS_NOTIFICATION_EMAIL]" label="Email address(es) that should be notified of New Comments (Enter multiple addresses by using a comma to separate them)"|gettext value=$smarty.const.COMMENTS_NOTIFICATION_EMAIL}
                </div>
                <div id="tab5">
	                ...
	                {control type="dropdown" name="sc[DISPLAY_DEFAULT_TIMEZONE]" label="Default timezone for this site. CAUTION: This may break calendars and other features that use date functions if you change this after entering data."|gettext items=$timezones default=$smarty.const.DISPLAY_DEFAULT_TIMEZONE}

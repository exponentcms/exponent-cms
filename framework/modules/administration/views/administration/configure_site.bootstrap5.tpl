            ...
            <div class="tab-content">
                ...
                <div id="tab13" role="tabpanel" class="tab-pane fade">
                   ...
                   <div id="alt-control-pdf" class="alt-control">
                       ...
                       <div class="alt-body">
                           {control type=radiogroup columns=4 name="sc[HTMLTOPDF_ENGINE]" items="None,mPDF v8,mPDF v8.2,dompdf v0.8+,dompdf v3,HTML2PDF v5,WKHTMLtoPDF"|gettxtlist values="none,expMPDF8,expMPDF81,expDOMPDF080,expDOMPDF2,expHTML2PDF5,expWKPDF" default=$smarty.const.HTMLTOPDF_ENGINE|default:"none"}

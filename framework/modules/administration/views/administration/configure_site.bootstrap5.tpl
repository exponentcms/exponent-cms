    ...
    {form controller="administration" action=update_siteconfig}
        <div id="{$config}" class="">
            <ul class="nav nav-tabs" role="tablist">
	            ...
	            <li role="presentation" class="nav-item"><a href="#tab2" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Anti-Spam"|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab3" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"User Registration"|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab4" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Comment Policies"|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab5" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Display"|gettext}</em></a></li>
                <li role="presentation" class="nav-item"><a href="#tab6" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"File Manager"|gettext}</em></a></li>
	            {if $user->isSuperAdmin()}
					<li role="presentation" class="nav-item"><a href="#tab7" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Mail Server"|gettext}</em></a></li>
		            <li role="presentation" class="nav-item"><a href="#tab8" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Maintenance"|gettext}</em></a></li>
		            <li role="presentation" class="nav-item"><a href="#tab9" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Security"|gettext}</em></a></li>
					<li role="presentation" class="nav-item"><a href="#tab10" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Help Links"|gettext}</em></a></li>
					<li role="presentation" class="nav-item"><a href="#tab11" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Content Editors"|gettext}</em></a></li>
		            <li role="presentation" class="nav-item"><a href="#tab12" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Error Messages"|gettext}</em></a></li>
		            <li role="presentation" class="nav-item"><a href="#tab13" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"PDF Generation"|gettext}</em></a></li>
					<li role="presentation" class="nav-item"><a href="#tab14" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Minify"|gettext}</em></a></li>
					<li role="presentation" class="nav-item"><a href="#tab15" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Search Report"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab16" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"e-Commerce"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab17" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Profiles"|gettext}</em></a></li>
	            {/if}
            </ul>
            <div class="tab-content">
                <div id="tab1" role="tabpanel" class="tab-pane fade show active">
                    ...
                    {control type="text" name="sc[SITE_URL]" label="Site URL"|gettext value=$smarty.const.HOSTNAME description='Enter the site domain name to prevent Host Header Injections. 0 to disable check'|gettext}
                ...
                <div id="tab13" role="tabpanel" class="tab-pane fade">
                   ...
                   <div id="alt-control-pdf" class="alt-control">
                       ...
                       <div class="alt-body">
                           {control type=radiogroup columns=4 name="sc[HTMLTOPDF_ENGINE]" items="None,mPDF v5,mPDF v6,mPDF v7,mPDF v8,mPDF v8.1,dompdf v0.6,dompdf v0.7,dompdf v0.8+,dompdf v2,HTML2PDF v4,HTML2PDF v5,WKHTMLtoPDF"|gettxtlist values="none,expMPDF,expMPDF6,expMPDF7,expMPDF8,expMPDF81,expDOMPDF,expDOMPDF070,expDOMPDF080,expDOMPDF2,expHTML2PDF,expHTML2PDF5,expWKPDF" default=$smarty.const.HTMLTOPDF_ENGINE|default:"none"}
                           ...
                           <div id="expMPDF-div" class="alt-item" style="display:none;">
                               ...
                               {/if}
                               <blockquote>
                                   {'MPDF v5 is an optional package. To obtain it, you must first download, then install it using one of the methods below.'|gettext}
                                   <ol>
                           ...
                           <div id="expMPDF6-div" class="alt-item" style="display:none;">
                               ...
                               {/if}
                               <blockquote>
                                   {'MPDF v6 is an optional package.  To obtain it, you must first download, then install it using the method below.'|gettext}
                                   <ol>
                                       <li>{'Download the basic library'|gettext} <a href="https://github.com/mpdf/mpdf/archive/v6.1.4.zip" target="_blank">MPDF6.1.4.zip</a>
                           ...
                           <div id="expMPDF8-div" class="alt-item" style="display:none;">
                               {if !file_exists("`$smarty.const.BASE`external/mpdf-`$smarty.const.MPDF8_VERSION`/src/Mpdf.php")}
                                   <div style="color:#ff0000;font-weight:bold;">
                                       {'mPDF v8 is NOT installed!'|gettext}
                                   </div>
                               {else}
                                   <div>
                                       {'mPDF v8 is installed!'|gettext}
                                   </div>
                               {/if}
                               <blockquote>
                           ...
                           <div id="expMPDF81-div" class="alt-item" style="display:none;">
                               ...
                               {/if}
                               <blockquote>
                                   {'MPDF v8.1 is an optional package, but the preferred generator.  To obtain it, you must first download the customized version of the library'|gettext} <a href="http://sourceforge.net/projects/exponentcms/files/Add-ons/mpdf81v271.zip/download" target="_blank">mpdf81v271.zip</a>.
                                   {'and then'|gettext} <a href="install_extension">{'Install New Extension'|gettext}</a> {'on your server with \'Patch Exponent CMS\' checked.'|gettext}
                               </blockquote>
                           </div>
                           ...
                           <div id="expDOMPDF080-div" class="alt-item" style="display:none;">
                               {if !file_exists("`$smarty.const.BASE`external/dompdf`$smarty.const.DOMPDF8_VERSION`/autoload.inc.php")}
                                   <div style="color:#ff0000;font-weight:bold;">
                           ...
                           <div id="expDOMPDF2-div" class="alt-item" style="display:none;">
                               {if !file_exists("`$smarty.const.BASE`external/dompdf-`$smarty.const.DOMPDF2_VERSION`/vendor/autoload.php")}
                                   <div style="color:#ff0000;font-weight:bold;">
                                       {'Dompdf v2 is NOT installed!'|gettext}
                                   </div>
                               {else}
                                   <div>
                                       {'Dompdf v2 is installed!'|gettext}
                                   </div>
                               {/if}
                               <blockquote>
                                   {'DOMPDF v2 is an optional package.  To obtain it, you must first download our customized version of the library'|gettext} <a href="https://sourceforge.net/projects/exponentcms/files/Add-ons/dompdf2v271.zip/download" target="_blank">dompdf2v271.zip</a>.
                                   {'and then'|gettext} <a href="install_extension">{'Install New Extension'|gettext}</a> {'on your server with \'Patch Exponent CMS\' checked.'|gettext}
                               </blockquote>
                           </div>
                           <div id="expHTML2PDF-div" class="alt-item" style="display:none;">
                               {if !file_exists("`$smarty.const.BASE`external/html2pdf/html2pdf.class.php") || !file_exists("`$smarty.const.BASE`external/TCPDF/tcpdf.php")}
                                   <div style="color:#ff0000;font-weight:bold;">
                                       {'HTML2PDF v4/TCPDF is NOT installed!'|gettext}
                                   </div>
                               {else}
                                   <div>
                                       {'HTML2PDF v4/TCPDF is installed!'|gettext}
                                   </div>
                               {/if}
                               <blockquote>
                                   {'HTML2PDF v4 is an optional package.  To obtain it, you must first download our customized version of the library'|gettext} <a href="http://sourceforge.net/projects/exponentcms/files/Add-ons/html2pdf.zip/download" target="_blank">html2pdf.zip</a>.
                                   {'and then'|gettext} <a href="install_extension">{'Install New Extension'|gettext}</a> {'on your server with \'Patch Exponent CMS\' checked.'|gettext}
                               </blockquote>
                           </div>
                           <div id="expHTML2PDF5-div" class="alt-item" style="display:none;">
                               ...
                               {else}
                                   <div>
                                       {'HTML2PDF v5/TCPDF is installed!'|gettext}
                                   </div>
                               {/if}
                               <blockquote>
                                   {'HTML2PDF v5 is an optional package.  To obtain it, you must first download our customized version of the library'|gettext} <a href="http://sourceforge.net/projects/exponentcms/files/Add-ons/html2pdf271.zip/download" target="_blank">html2pdf5v271.zip</a>.
                                   {'and then'|gettext} <a href="install_extension">{'Install New Extension'|gettext}</a> {'on your server with \'Patch Exponent CMS\' checked.'|gettext}
                               </blockquote>
                           </div>
				...
				<div id="tab14" role="tabpanel" class="tab-pane fade">
                    ...
                    {group label="Minify Debugging Settings"|gettext}
                        ...
                        {control type="checkbox" postfalse=1 name="sc[MINIFY_LESS]" label="Minify .less/.scss compiled style-sheets?"|gettext checked=$smarty.const.MINIFY_LESS value=1}

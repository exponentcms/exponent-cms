                   ...
                   <div id="alt-control-pdf" class="alt-control">
                       ...
                       <div class="alt-body">
                           ...
                           <div id="expMPDF81-div" class="alt-item" style="display:none;">
                               ...
                               {else}
                                   <div>
                                       {'mPDF v8.2 is installed!'|gettext}
                                   </div>
                               {/if}
                               <blockquote>
                                   {'MPDF v8.2 is an optional package, but the preferred generator.  To obtain it, you must first download the customized version of the library'|gettext} <a href="http://sourceforge.net/projects/exponentcms/files/Add-ons/mpdf82v272.zip/download" target="_blank">mpdf82v272.zip</a>.
                                   {'and then'|gettext} <a href="install_extension">{'Install New Extension'|gettext}</a> {'on your server with \'Patch Exponent CMS\' checked.'|gettext}
                               </blockquote>
                           </div>
                           ...
                           <div id="expDOMPDF2-div" class="alt-item" style="display:none;">
                               {if !file_exists("`$smarty.const.BASE`external/dompdf-`$smarty.const.DOMPDF2_VERSION`/vendor/autoload.php")}
                                   <div style="color:#ff0000;font-weight:bold;">
                                       {'Dompdf v3 is NOT installed!'|gettext}
                                   </div>
                               {else}
                                   <div>
                                       {'Dompdf v3 is installed!'|gettext}
                                   </div>
                               {/if}
                               <blockquote>
                                   {'DOMPDF v3 is an optional package.  To obtain it, you must first download our customized version of the library'|gettext} <a href="https://sourceforge.net/projects/exponentcms/files/Add-ons/dompdf3v272.zip/download" target="_blank">dompdf3v272.zip</a>.
                                   {'and then'|gettext} <a href="install_extension">{'Install New Extension'|gettext}</a> {'on your server with \'Patch Exponent CMS\' checked.'|gettext}
                               </blockquote>
                           </div>
                           ...
                           <div id="expHTML2PDF5-div" class="alt-item" style="display:none;">
                               {if !file_exists("`$smarty.const.BASE`external/html2pdf-`$smarty.const.HTML2PDF5_VERSION`/vendor/autoload.php")}
                                   <div style="color:#ff0000;font-weight:bold;">
                                       {'HTML2PDF v5 is NOT installed!'|gettext}
                                   </div>
                               {else}
                                   <div>
                                       {'HTML2PDF v5 is installed!'|gettext}
                                   </div>
                               {/if}
                               <blockquote>
                                   {'HTML2PDF v5 is an optional package.  To obtain it, you must first download our customized version of the library'|gettext} <a href="http://sourceforge.net/projects/exponentcms/files/Add-ons/html2pdf272.zip/download" target="_blank">html2pdf5v272.zip</a>.
                                   {'and then'|gettext} <a href="install_extension">{'Install New Extension'|gettext}</a> {'on your server with \'Patch Exponent CMS\' checked.'|gettext}
                               </blockquote>
                           </div>

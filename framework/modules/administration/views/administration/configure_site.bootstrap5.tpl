                   ...
                   <div id="alt-control-pdf" class="alt-control">
                       ...
                       <div class="alt-body">
                           ...
                           <div id="expHTML2PDF5-div" class="alt-item" style="display:none;">
                               ...
                               {/if}
                               <blockquote>
                                   {'HTML2PDF v5 is an optional package.  To obtain it, you must first download our customized version of the library'|gettext} <a href="http://sourceforge.net/projects/exponentcms/files/Add-ons/html2pdf5.zip/download" target="_blank">html2pdf5v260.zip</a>.
                                   {'and then'|gettext} <a href="install_extension">{'Install New Extension'|gettext}</a> {'on your server with \'Patch Exponent CMS\' checked.'|gettext}
                               </blockquote>
                           </div>

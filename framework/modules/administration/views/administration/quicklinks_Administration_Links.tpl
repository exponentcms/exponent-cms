...
<div class="administrationmodule quicklinks yui-panel">
	...
	<div class="bd">		
	{permissions}
	{if $can_manage_nav == 1}<a class="sitetree" href="{link module=navigation action=manage}">{'Manage Site Navigation'|gettext}</a>{/if}
		{if $permissions.manage == 1}
		<a class="files" href="{$smarty.const.PATH_RELATIVE}framework/modules-1/filemanagermodule/actions/picker.php">{'Manage Files'|gettext}</a>

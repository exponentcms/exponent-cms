    ...
    {form controller="administration" action=update_siteconfig}
        <div id="{$config}" class="">
            <ul class="nav nav-tabs" role="tablist">
	            ...
	            <li role="presentation" class="nav-item"><a href="#tab2" class="nav-link" role="tab" data-toggle="tab"><em>{"Anti-Spam"|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab3" class="nav-link" role="tab" data-toggle="tab"><em>{"User Registration"|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab4" class="nav-link" role="tab" data-toggle="tab"><em>{"Comment Policies"|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab5" class="nav-link" role="tab" data-toggle="tab"><em>{"Display"|gettext}</em></a></li>
                <li role="presentation" class="nav-item"><a href="#tab6" class="nav-link" role="tab" data-toggle="tab"><em>{"File Manager"|gettext}</em></a></li>
	            {if $user->isSuperAdmin()}
					<li role="presentation" class="nav-item"><a href="#tab7" class="nav-link" role="tab" data-toggle="tab"><em>{"Mail Server"|gettext}</em></a></li>
		            <li role="presentation" class="nav-item"><a href="#tab8" class="nav-link" role="tab" data-toggle="tab"><em>{"Maintenance"|gettext}</em></a></li>
		            <li role="presentation" class="nav-item"><a href="#tab9" class="nav-link" role="tab" data-toggle="tab"><em>{"Security"|gettext}</em></a></li>
					<li role="presentation" class="nav-item"><a href="#tab10" class="nav-link" role="tab" data-toggle="tab"><em>{"Help Links"|gettext}</em></a></li>
					<li role="presentation" class="nav-item"><a href="#tab11" class="nav-link" role="tab" data-toggle="tab"><em>{"Content Editors"|gettext}</em></a></li>
		            <li role="presentation" class="nav-item"><a href="#tab12" class="nav-link" role="tab" data-toggle="tab"><em>{"Error Messages"|gettext}</em></a></li>
		            <li role="presentation" class="nav-item"><a href="#tab13" class="nav-link" role="tab" data-toggle="tab"><em>{"PDF Generation"|gettext}</em></a></li>
					<li role="presentation" class="nav-item"><a href="#tab14" class="nav-link" role="tab" data-toggle="tab"><em>{"Minify"|gettext}</em></a></li>
					<li role="presentation" class="nav-item"><a href="#tab15" class="nav-link" role="tab" data-toggle="tab"><em>{"Search Report"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab16" class="nav-link" role="tab" data-toggle="tab"><em>{"e-Commerce"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab17" class="nav-link" role="tab" data-toggle="tab"><em>{"Profiles"|gettext}</em></a></li>
	            {/if}
            </ul>

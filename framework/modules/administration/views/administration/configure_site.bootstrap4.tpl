        ...
        <div id="{$config}" class="">
            ...
            <div class="tab-content">
                ...
                <div id="tab16" role="tabpanel" class="tab-pane fade">
                    ...
                    {control type="checkbox" postfalse=1 name="sc[SIMPLE_PERMISSIONS]" label="Use Simple Permissions?"|gettext checked=$smarty.const.SIMPLE_PERMISSIONS value=1 description='This will simplify and speed up the permission system to only basic users and admins. Any User and Group Permissions will not apply.'|gettext}

...
<div class="module flowplayer edit">
    ...
    {form action=update}
        ...
        {control type=text name=url label="YouTube Video URL"|gettext value=$record->url size=25 description='A link to a YouTube video.  YouTube url takes pecedence over an attached file.'|gettext}

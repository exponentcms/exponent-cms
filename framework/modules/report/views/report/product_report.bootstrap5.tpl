...
{css unique="general-ecom" link="`$smarty.const.PATH_RELATIVE`framework/modules/ecommerce/assets/css/ecom-bs3.css" corecss="tree,button,panel,panels"}
                ...
                <tbody>
                    ...
                    <tr class="even">
                        ...
                        <div>{control type="checkbox" name="uncategorized" flip=true label="Uncategorized Products Only"|gettext value=1}  </div>
                            <div class="control" data-bs-toggle="modal" data-bs-target="#catModal" data-bs-backdrop="static">
                            ...
                            {*</div>*}
                            <!-- Modal -->
                            <div class="modal fade" id="catModal" tabindex="-1" aria-labelledby="showcats" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-bs-dismiss="modal">{'Close'|gettext}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

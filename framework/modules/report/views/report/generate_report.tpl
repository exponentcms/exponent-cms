...
<div class="module report generate-report">
    ...
    <div class="actions-to-apply">
        {control type="dropdown" name="action" label="Select Action"|gettext items="Add Notes,Delete,Apply Discount,Refund"|gettextlist values="Add Notes,Delete,Apply Discount,Refund"}

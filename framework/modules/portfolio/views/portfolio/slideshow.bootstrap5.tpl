    ...
    <div class="row">
        ...
        {if !$config.hidecontrols && $slides|@count > 1}
            ...
            <div class="row cu-controls">
                <div class="col-sm-12">
                    <a href="#ss-{$name}" data-slide="prev" class="sercacontrol"><i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-chevron-left{else}fas fa-chevron-left fa-fw{/if}"></i></a>
                    <a href="#ss-{$name}" data-slide="next" class="sercacontrol next"><i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-chevron-right{else}fas fa-chevron-right fa-fw{/if}"></i></a>

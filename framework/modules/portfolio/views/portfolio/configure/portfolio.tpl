...
{control type="radiogroup" name="usebody" label="Display Description in List"|gettext value=$config.usebody|default:0 items="Full,Summary,None"|gettxtlist values="0,1,2"}

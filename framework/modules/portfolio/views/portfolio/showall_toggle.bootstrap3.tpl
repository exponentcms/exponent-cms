    ...
    $(document).ready(function() {
        ...
        var handleSuccess_{/literal}{$name}{literal} = function(o, ioId){
            if(o){
                ...
                portfoliolist_{/literal}{$name}{literal}.find('script').each(function(n){
                    if(!$(n).attr('src')){
                        eval($(n).html);
                    } else {
                ...
                portfoliolist_{/literal}{$name}{literal}.find('link').each(function(n){
        ...
        portfoliolist_{/literal}{$name}{literal}.delegate('a.pager', 'click', function(e){
            e.preventDefault();
            History.pushState({name:'{/literal}{$name}{literal}', rel:e.target.rel}, '{/literal}{'Portfoio'|gettext}{literal}', orig_url_{/literal}{$name}{literal} + page_parm_{/literal}{$name}{literal} + e.target.rel);

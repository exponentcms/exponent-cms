...
{script unique="manage-users" jquery='jquery.dataTables,dataTables.bootstrap4'}
{literal}
    ...
    {literal}
            processing: true,
            "language": {
                processing: '<i class="{/literal}{$icon}{literal}"></i> <span>Loading Records...</span> '
            },
            serverSide: true,

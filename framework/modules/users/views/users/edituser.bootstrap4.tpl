	    ...
	    <div id="edituser-tabs" class="">
		    <ul class="nav nav-tabs" role="tablist">
                ...
                {if !empty($groups->records)}
                    <li role="presentation" class="nav-item"><a href="#tab2" class="nav-link" role="tab" data-toggle="tab"><em>{"Group Membership"|gettext}</em></a></li>
                {/if}
                {foreach from=$extensions item=extension}
		            <li role="presentation" class="nav-item"><a href="#tab{$extension->id+2}" class="nav-link" role="tab" data-toggle="tab"><em>{$extension->title}</em></a></li>
                {/foreach}
		    </ul>

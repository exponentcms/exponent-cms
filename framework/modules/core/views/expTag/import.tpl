...
<div class="module importexport import-product">
    ...
    <blockquote>
        {'This CSV file can be created using the Exponent, Super-Admin Tools, Database, Import/Export Data menu item and then selecting Export Data, Tag manager'|gettext}{br}
        {icon class=export controller=expTag action=export}{br}
    </blockquote>
    {form action=importTags}

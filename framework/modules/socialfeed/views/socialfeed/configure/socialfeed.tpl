...
{if bs3()}
{control type=dropdown name="socialfeed_display_type" items="Collapsing Columns,Fluid,Pinboard"|gettxtlist values="columns,fluid,pinboard" label="Bootstrap 3 display style"|gettext value=$config.socialfeed_display_type|default:'fluid'}
{/if}

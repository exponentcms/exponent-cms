...
{control type=dropdown name=order label="Sort By"|gettext items="Date Added, Order Manually"|gettext values="created_at,rank" value=$config.order|default:rank}
{control type=dropdown name=dir label="Sort Order"|gettext items="Newest First, Oldest First"|gettext values="DESC, ASC" value=$config.dir}

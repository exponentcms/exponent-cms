    ...
    {form action=update record=$record}
        ...
        <div id="edithelp-tabs" class="">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="nav-item"><a href="#tab2" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Actions and Views'|gettext}</em></a></li>
                <li role="presentation" class="nav-item"><a href="#tab3" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Configuration'|gettext}</em></a></li>
                <li role="presentation" class="nav-item"><a href="#tab4" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Videos'|gettext}</em></a></li>
                <li role="presentation" class="nav-item"><a href="#tab5" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Additional Information'|gettext}</em></a></li>
                <li role="presentation" class="nav-item"><a href="#tab6" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'SEO'|gettext}</em></a></li>
            </ul>
            ...
            <div id="tab1" role="tabpanel" class="tab-pane fade show active">
                ...
                {control type="dropdown" name="parent" label="Parent Help Doc"|gettext items=$parents value=$record->parent|default:$parent}

    ...
    <div id="alt-control-landing" class="alt-control">
        ...
        <div class="alt-body">
            ...
            <div id="slideshow-div" class="alt-item" style="display:none;">
                ...
                {control type=text name="width" label="Slideshow Width"|gettext value=$config.width|default:350 size="5" description='Used to determine box ratio'|gettext}
                {control type=text name="height" label="Slideshow Height"|gettext value=$config.height|default:200 size="5" description='Used to determine box ratio'|gettext}

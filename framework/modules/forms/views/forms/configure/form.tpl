...
{control type="dropdown" name="forms_id" label="Select the Form"|gettext items=$forms_list default=$config.forms_id required=true}
...
{control type=html name='response' label='Response after submission'|gettext value=$config.response description='Message to display after submitting a form.'|gettext}

...
{if $config.is_saved && !empty($config.table_name)}
    ...
    {control type="checkbox" name="is_searchable" label="Return as Search Results?"|gettext value=1 checked=$config.is_searchable disabled=true description='Add form records imto search index to appear as search results'|gettext}
{/if}

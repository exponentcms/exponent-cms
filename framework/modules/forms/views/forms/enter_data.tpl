...
<div class="module formmodule forms edit enter-data default">
    ...
    <div class="bodycopy">
        {if empty($form)}
            {permissions}
                <div class="module-actions">
                    <div class="msg-queue notice" style="text-align:center"><p>{'You MUST select a form!'|gettext} {icon action="configure"}</p></div>
                </div>
            {/permissions}
        {else}
            {if $description != ""}

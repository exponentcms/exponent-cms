...
{control type=dropdown name=pagelinks label="Show page links"|gettext items="Top and Bottom,Top Only,Bottom Only,Don't show page links"|gettextlist values="Top and Bottom,Top Only,Bottom Only,Don't show page links" value=$config.pagelinks}

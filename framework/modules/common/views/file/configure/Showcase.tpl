...
{control type="dropdown" name="lpfloat" label="File Display Box Float"|gettext items="No Float,Left,Right"|gettxtlist values="No Float,Left,Right" value=$config.lpfloat}
...
{control type="radiogroup" columns=2 name="hoverorclick" label="Replace main image on click or hover?"|gettext items="Click,Hover"|gettxtlist values="1,2"  default=$config.hoverorclick|default:"1"}

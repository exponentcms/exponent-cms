...
{control type="dropdown" name="floatthumb" label="Float Thumbnails"|gettext items="No Float,Left,Right"|gettextlist values="No Float,Left,Right" value=$config.floatthumb}

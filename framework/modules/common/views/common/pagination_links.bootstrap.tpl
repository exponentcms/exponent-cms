...
{if $page->total_records > 0}
    <div class="pagination-links">
        <div class="pagination pagination-small" aria-label="{'Page navigation'|gettext}">
            <ul>
            {if $page->previous_page != ''}<li><a class="pager prev" href="{$page->previous_page}" rel="{$page->previous_pagenum}"><span aria-hidden="true">&laquo;</span></a></li> {/if}

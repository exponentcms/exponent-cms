...
//			    'state'=>array('message'=>'You must choose a state.'),
    ...
    {                             
        ...
        if (!$user->isLoggedIn())
        {
            ...
            {
                expValidator::failAndReturnToForm(gt("The email address you entered already exists as a user. If you have lost your password, you may reset it here:")." <a href='".makeLink(array('controller'=>'users','action'=>'reset_password'))."'>Reset Password</a>.", $_POST);
            }
            $user->is_admin = false;

...
<div class="module address edit address-form">
    ...
    {form action=update}
        ...
        {control type="dropdown" name="address_type" label="Address Type"|gettext items="Business,Military,Residential"|gettextlist values="Business,Military,Residential" default=$record->address_type|default:"Residential"}

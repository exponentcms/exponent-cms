...
<div class="exp-container edit {if !$error}hide{/if} bootstrap3">
...
//            };
        ...
        EXPONENT.useRecycled = function(src) {
            ...
            Y.all('#browse-bin > i').removeClass('fa fa-trash-o fw');
            Y.all('#browse-bin > i').addClass('fa fa-check-square-o fw');
        }
        ...
        EXPONENT.clearRecycledSource = function() {
            ...
            Y.all('#browse-bin > i').addClass('fa fa-trash-o fw');
            Y.all('#browse-bin > i').removeClass('fa fa-check-square-o fw');
        }

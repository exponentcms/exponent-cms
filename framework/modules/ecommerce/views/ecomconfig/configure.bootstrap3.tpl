        ...
        {form action=saveconfig}
            <div id="storetabs" class="">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab2" data-toggle="tab"><em>{'Cart Settings'|gettext}</em></a></li>
                    <li><a href="#tab3" data-toggle="tab"><em>{'Categories and Display Options'|gettext}</em></a></li>
                    <li><a href="#tab4" data-toggle="tab"><em>{'Notifications'|gettext}</em></a></li>
                    <li><a href="#tab5" data-toggle="tab"><em>{'Emails'|gettext}</em></a></li>
                    <li><a href="#tab6" data-toggle="tab"><em>{'Geography'|gettext}</em></a></li>
                    <li><a href="#tab7" data-toggle="tab"><em>{'Invoice'|gettext}</em></a></li>
                    <li><a href="#tab8" data-toggle="tab"><em>{'Display & Feature Settings'|gettext}</em></a></li>
                    <li><a href="#tab9" data-toggle="tab"><em>{'Product Types'|gettext}</em></a></li>
                    <li><a href="#tab10" data-toggle="tab"><em>{'Gift Cards'|gettext}</em></a></li>
                </ul>

        ...
        {form action=saveconfig}
            <div id="storetabs" class="">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="nav-item"><a href="#tab2" class="nav-link" role="tab" data-toggle="tab"><em>{'Site'|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab3" class="nav-link" role="tab" data-toggle="tab"><em>{'Cart'|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab4" class="nav-link" role="tab" data-toggle="tab"><em>{'Display'|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab5" class="nav-link" role="tab" data-toggle="tab"><em>{'Invoices'|gettext}</em></a></li>
                    {*<li role="presentation" class="nav-item"><a href="#tab6" class="nav-link" role="tab" data-toggle="tab"><em>{'Notifications'|gettext}</em></a></li>*}
                    <li role="presentation" class="nav-item"><a href="#tab7" class="nav-link" role="tab" data-toggle="tab"><em>{'Location'|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab8" class="nav-link" role="tab" data-toggle="tab"><em>{'Product Feeds'|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#tab9" class="nav-link" role="tab" data-toggle="tab"><em>{'Gift Cards'|gettext}</em></a></li>
                </ul>

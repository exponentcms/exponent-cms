...
<div id="managepurchaseorders" class="module purchaseorder manage">
    ...
    <div class="filters">
        ...
        {control type="dropdown" name="status" label="Show"|gettext items="All Orders,Only Open Orders, Only Closed Orders"|gettext values="All Orders,Only Open Orders, Only Closed Orders"}
        {control type="dropdown" name="daterange" label="Within"|gettext items="The last Month,The Last 6 months,The Last Year,All Time"|gettext values="The last Month,The Last 6 months,The Last Year,All Time"}
    </div>
	-->
	<div class="leftcol">

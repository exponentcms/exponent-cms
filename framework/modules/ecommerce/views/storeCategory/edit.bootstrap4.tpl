        ...
        {form controller=storeCategory action=$action}
            ...
            <div id="cattabs" class="">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="nav-item"><a href="#seo" class="nav-link" role="tab" data-toggle="tab"><em>{'SEO'|gettext}</em></a></li>
                    {*<li><a href="#events1"><em>{'Events'|gettext}</em></a></li>*}
                    {if $product_types}
                        {foreach from=$product_types key=key item=item}
                            <li role="presentation" class="nav-item"><a href="#{$item}" class="nav-link" role="tab" data-toggle="tab"><em>{$key} {'Product Types'|gettext}</em></a></li>
                        {/foreach}
                    {/if}
                </ul>

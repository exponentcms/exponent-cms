...
{script unique="manage-orders" jquery='moment,bootstrap-datetimepicker,select2,jquery.dataTables,dataTables.bootstrap4,jquery.dataTables.yadcf'}
{literal}
...
//        };
    ...
    {literal}
            processing: true,
            "language": {
                processing: '<i class="{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-arrow-repeat bi-spin{else}fas fa-spinner fa-spin fa-fw{/if}{literal}"></i> <span>{/literal}{'Loading Records'|gettext}...{literal}</span> '
            },
            serverSide: true,
    ...
    {literal}
            ...
            columns: [
                { data: 'name', type: 'html' },
                { data: 'invoice_id', type: 'html', "orderSequence": [ "desc", "asc" ] },

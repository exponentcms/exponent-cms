...
<div id="order" class="module order show">
    <div id="ordertabs" class="">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#invoice" data-toggle="tab"><em>{'Receipt'|gettext}</em></a></li>
            <li><a href="#ordhistory" data-toggle="tab"><em>{'Order History'|gettext}</em></a></li>
            <li><a href="#shipinfo" data-toggle="tab"><em>{'Shipping Information'|gettext}</em></a></li>
            <li><a href="#billinfo" data-toggle="tab"><em>{'Billing Information'|gettext}</em></a></li>
            {permissions}
                {if $permissions.manage}
                    <li><a href="#addinfo" data-toggle="tab"><em>{'Additional Information'|gettext}</em></a></li>
                    <li><a href="#notes" data-toggle="tab"><em>{'Notes & Communications'|gettext}</em></a></li>
                {/if}
            {/permissions}                                                           
        </ul>   
                 
        <div class="tab-content exp-ecom-table">
            ...
            <div id="shipinfo" class="tab-pane fade">

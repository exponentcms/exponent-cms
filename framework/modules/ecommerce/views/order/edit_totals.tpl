...
<div class="module address edit address-form">
    ...
    {form action=save_totals}
        ...
        * Keep in mind, if you edit, add, or remove order items, the order will automatically recalculate these totals. {br}
        ...
        <tr><td> 
        {control type=text name=total_discounts label="Total Discounts"|gettext value=$order->total_discounts}</td><td> * Total discounts you want reflected on this order.
        </td></tr>
        <tr><td> 
        {control type=text name=tax label="Tax" value=$order->tax}</td><td>* Total of tax for this order
        </td></tr>
        <tr><td> 
        {control type=text name=shipping_total label="Shipping Total"|gettext value=$order->shipping_total}</td><td> * Total of shipping for this order.
        </td></tr>
        <tr><td> 
        {control type=text name=surcharge_total label="Surcharge Total"|gettext value=$order->surcharge_total} </td><td>* Total of per-product shipping surcharges.
        </td></tr>
        <tr><td> 
        ...
        {control type=text name=grand_total label="Grand Total"|gettext value=$order->grand_total}</td><td> * Grand total of the order
        </td></tr>
        <tr><td> 

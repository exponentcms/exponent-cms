    ...
    {form action=save_totals}
        ...
        * {'Keep in mind, if you edit, add, or remove order items, the order will automatically recalculate these totals.'|gettext} {br}
        ...
        <table width='60%'>
            ...
            <tr><td>
                {control type=text name=surcharge_total label="Surcharge Total"|gettext value=$order->surcharge_total filter=money} </td><td>* {'Total of per-product freight surcharges.'|gettext}
            </td></tr>
            <tr><td>

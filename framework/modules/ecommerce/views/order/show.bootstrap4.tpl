                ...
                <div class="card">
                    ...
                    <ul id="tabOrder" class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="nav-item">
                            <a href="#status" class="nav-link active" role="tab" data-toggle="tab">
                        ...
                        <li role="presentation" class="nav-item">
                            <a href="#other" class="nav-link" role="tab" data-toggle="tab">
                                    ...
                                    <table class="table order-info order-info2">
                                        <thead id="change-status">
                                            <tr>
                                                ...
                                                <th title="{'Click to change order type or status'|gettext}"><i class="fas fa-angle-double-down"></i> {'Update Order Type and Order Status'|gettext}</th>
                                            </tr>
                                        </thead>
                    ...
                    <ul id="myTab" class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="nav-item">
                            <a href="#shipping" class="nav-link active" role="tab" data-toggle="tab">
                                <i class="fas fa-truck"></i>
                                {'Shipping'|gettext}
                            </a>
                        </li>
                        <li role="presentation" class="nav-item">
                            <a href="#tracking" class="nav-link" role="tab" data-toggle="tab">
            ...
            <div class="col-lg-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <dl class="card card-body bg-faded list-detail">
                                ...
                                <dd>
                                    <a href="mailto:{$order_user->email}" title="{'Email customer'|gettext}"><i class="far fa-envelope"></i> {$order_user->email}</a>
                                </dd>
                                <dt>
                                    {'Account Registered'|gettext}
                                </dt>
                                <dd class="text-muted">
                                    <i class="far fa-calendar-alt"></i> {$order_user->created_on|format_date:$smarty.const.DISPLAY_DATETIME_FORMAT}
                                </dd>
                                <dt>
                                    {'Last Visit'|gettext}
                                </dt>
                                <dd class="text-muted">
                                    <i class="far fa-calendar-alt"></i> {$order_user->last_login|format_date:$smarty.const.DISPLAY_DATETIME_FORMAT}
                                </dd>
                                <dt>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul id="tabAddresses" class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="nav-item">
                                    <a href="#addressShipping" class="nav-link active" role="tab" data-toggle="tab">
                                        <i class="fas fa-truck"></i>
                                        {'Shipping Address'|gettext}
                                    </a>
                                </li>
                                <li role="presentation" class="nav-item">
                                    <a href="#addressInvoice" class="nav-link" role="tab" data-toggle="tab">
                ...
                <!-- messages/notes -->
                    <div id="start_messages" class="card-header">
                        <i class="fas fa-envelope"></i> {'Messages'|gettext}
                        <span class="badge">
                    ...
                    <div class="card card-body bg-faded">
                        <div class="email-customer"><h4 id="email-customer" title="{'Click to create customer email'|gettext}"><i class="fas fa-angle-double-down"></i> {"Email the Customer about this order"|gettext}</h4></div>

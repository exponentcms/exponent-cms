...
{script unique="manage-products" jquery='jquery.dataTables,dataTables.bootstrap5,jquery.dataTables.yadcf'}
{literal}
    ...
    {literal}
            processing: true,
            "language": {
                processing: '<i class="{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-arrow-repeat bi-spin{else}fas fa-spinner fa-spin fa-fw{/if}{literal}"></i> <span>Loading Records...</span> '
            },
            serverSide: true,

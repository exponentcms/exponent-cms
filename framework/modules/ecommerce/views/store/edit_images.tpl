...
<div id="imagefunctionality">              
    ...
    {control type=files name="featured_image" label="Featured Product Images"|gettext subtype="featured_image" accept="image/*" value=$record->expFile folder=$config.upload_folder description="Images to use if this item is a featured product"|gettext}

...
{control type="checkbox"  name="quantity[allow_partial]" label="Allow partial quantities?" value=1 checked=$record->allow_partial}
{control type="checkbox" name="quantity[is_hidden]" label="Hide Product" value=1 checked=$record->is_hidden} 

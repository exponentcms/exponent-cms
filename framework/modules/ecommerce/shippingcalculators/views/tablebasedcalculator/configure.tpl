...
<div id="authcfg" class="hide exp-skin-tabview">
    ...
    <div id="auth" class="yui-navset">
        ...
        <div id="tab1">
            {control type="text" name="handling" label="Table Based Handling Charge" size=5 filter=money value=$calculator->configdata.handling}
            {control type="editor" name="message" label="Shipping Message" size=15 value=$calculator->configdata.message} 
        </div>
        </div>
    </div>
</div>

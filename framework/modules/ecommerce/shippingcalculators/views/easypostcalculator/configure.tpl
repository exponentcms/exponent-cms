    ...
    <div id="ups-tabs" class="yui-navset exp-skin-tabview hide">
        ...
        <div class="yui-content">
	        <div id="tab1">
                ...
                {control type="text" name="rate" label="Shipping & Handling Charge"|gettext size=5 filter=money value=$calculator->configdata.rate|default:'0.01' description='This is added to the cost of the shipping per package'|gettext}
	        </div>
	        <div id="tab2">

    ...
    <div id="ups-tabs" class="">
        ...
        <div class="tab-content">
	        <div id="tab1" role="tabpanel" class="tab-pane fade in active">
                ...
                {control type="text" name="handling" label="Shipping & Handling Charge"|gettext size=5 filter=money value=$calculator->configdata.handling|default:'0.01' description='This is added to the cost of the shipping per package'|gettext}
	        </div>

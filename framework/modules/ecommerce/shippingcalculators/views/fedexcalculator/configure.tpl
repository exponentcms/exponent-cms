    ...
    <div id="fedex-tabs" class="yui-navset exp-skin-tabview hide">
        ...
        <div class="yui-content">
	        ...
	        <div id="tab3">
                ...
                {control type="state" name="shipfrom[StateOrProvinceCode]" label="State"|gettext value=$calculator->configdata.shipfrom.StateOrProvinceCode}
                ...
                {control type="country" name="shipfrom[CountryCode]" label="Country"|gettext value=$calculator->configdata.shipfrom.CountryCode}
	        </div>
	        <div id="tab4">

...
<div id="worldpay">
    <div id="worldpay-tabs" class="">
        <ul class="nav nav-tabs" role="tablist">
	        <li role="presentation" class="nav-item"><a href="#tab1" class="nav-link active" role="tab" data-bs-toggle="tab"><em>{'Wordpay Checkout'|gettext}<br>{'Settings'|gettext}</em></a></li>

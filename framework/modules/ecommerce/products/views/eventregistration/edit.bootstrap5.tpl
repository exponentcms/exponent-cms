    ...
    {form action=update}
        ...
        <div id="editproduct-tabs" class="">
            <ul class="nav nav-tabs" role="tablist">
	            ...
	            <li role="presentation" class="nav-item"><a href="#tab2" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Dates'|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab3" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Pricing'|gettext}</em></a></li>
                <li role="presentation" class="nav-item"><a href="#tab4" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Options'|gettext}</em></a></li>
                <li role="presentation" class="nav-item"><a href="#tab5" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'User Input'|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab6" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Images & Files'|gettext}</em></a></li>
	            <li role="presentation" class="nav-item"><a href="#tab7" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'SEO'|gettext}</em></a></li>
				<li role="presentation" class="nav-item"><a href="#tab8" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Waiver'|gettext}</em></a></li>
				<li role="presentation" class="nav-item"><a href="#tab9" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Status'|gettext}</em></a></li>
            </ul>

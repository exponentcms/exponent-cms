...
<div class="module cart module addToCart">
    ...
    <p>{'Minimum donation amount is'|gettext} {currency_symbol}{$product->base_price|number_format:2}.</p>
    ...
    <a id="continue" class="awesome  {$smarty.const.BTN_SIZE} {$smarty.const.BTN_COLOR} rc-link" href="{link controller=cart action=addItem}">{'Add to cart'|gettext}<span></span></a>
</div>

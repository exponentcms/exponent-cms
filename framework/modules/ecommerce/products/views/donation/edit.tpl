        ...
        <div id="editproduct-tabs" class="yui-navset exp-skin-tabview hide">
            ...
            <div class="yui-content">
	            <div id="tab1">
	                ...
	                {control type="text" name="title" label="Cause Title"|gettext value=$record->title}
	            ...
	            <div id="tab2">
	                {control type="text" name="base_price" label="Minimum dollar ammount"|gettext value=$record->base_price filter=money}
	            </div>
	            <div id="tab3">

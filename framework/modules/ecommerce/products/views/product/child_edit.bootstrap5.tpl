        ...
        {form action=update}
            ...
            <div id="childtabs" class="">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="nav-item"><a href="#general" class="nav-link active" role="tab" data-bs-toggle="tab"><em>{"General"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#pricing" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Pricing, Tax & Discounts"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#images" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Images & Files"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#quantity" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Quantity"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#shipping" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Shipping"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#categories" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Categories"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#options" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Options"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#uifld" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"User Input Fields"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#active" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Active & Status Settings"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#notes" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Notes"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#xtrafields" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Extra Fields"|gettext}</em></a></li>
                    <li role="presentation" class="nav-item"><a href="#misc" class="nav-link" role="tab" data-bs-toggle="tab"><em>{"Misc"|gettext}</em></a></li>
                </ul>

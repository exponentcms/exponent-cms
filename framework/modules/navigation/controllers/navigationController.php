...
//    );
    ...
    protected $manage_permissions = array(
        ...
        'generateiteMap'    => 'Generate Sitemap',
    );
...
//                        $search_record->keywords .= " " . $textitem->title;  // fixme - we do NOT have these
            ...
            $search_record->body = !empty($search_record->body) ? substr($search_record->body, 0, 20000) : "";  // trim excessive body
...
//        }
    ...
    public function generateSiteMap() {
        ...
        $include_mobile = !empty($this->params['include_mobile']);
        $include_images = !empty($this->params['include_images']);
        $include_videos = !empty($this->params['include_videos']);
        $include_products = !empty($this->params['include_products']);
        ...
        $action_msg = "SC";
        fclose($handle);
        echo $nl,$nl,"Generated $count link(s)";
        if ($include_images)

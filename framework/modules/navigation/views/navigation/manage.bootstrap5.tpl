...
<div id="navmanager" class="module navigation manager">
	...
	<div id="navmanager-tabs" class="">
	    <ul class="nav nav-tabs" role="tablist">
        	<li role="presentation" class="nav-item"><a href="#tab1" class="nav-link active" role="tab" data-bs-toggle="tab"><em>{'Menu Hierarchy'|gettext}</em></a></li>
	    ...
	    <div class="tab-content">
        	<div id="tab1" role="tabpanel" class="tab-pane fade show active">{exp_include file="manage_hierarchy.tpl"}</div>

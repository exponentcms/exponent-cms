...
<nav id="topnavbar" class="navigation navbar yamm navbar-expand-sm navbar-light bg-light {if $smarty.const.MENU_LOCATION}{$smarty.const.MENU_LOCATION}{/if}" role="navigation">
    <div class="container{$smarty.const.STYLE_WIDTH}">
        <!-- Brand and toggle get grouped for better mobile display -->
        {*<div class="navbar-header">*}
            {*<button type="button" class="navbar-toggle hidden-sm-up navbar-toggler" data-bs-toggle="collapse" data-bs-target="#bs-navbar-collapse-1">*}
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#bs-navbar-collapse-1" aria-controls="navbarNav" aria-expanded="false" aria-label="{'Toggle navigation'|gettext}">
                Menu
        ...
        <div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
            <ul class="nav navbar-nav{if $smarty.const.MENU_ALIGN == 'right'} navbar-right ms-auto{/if}">

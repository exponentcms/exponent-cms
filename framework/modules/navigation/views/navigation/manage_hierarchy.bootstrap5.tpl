...
{script unique="navtree" jquery="jstree,bootbox.all" bootstrap="modal"}
{literal}
    $(document).ready(function(){
        ...
        $('#nav_jstree').jstree({
            ...
            'contextmenu' : {
                'items' : {
                    "add" : {
                        "icon"				: '{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-plus-circle{else}fa fa-lg fa-fw fa-plus-circle{/if}{literal} text-success',
    				...
    				"view" : {
                        "icon"				: '{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-search{else}fa fa-lg fa-fw fa-search{/if}{literal}',
    				...
    				"edit" : {
                        "icon"				: '{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-pencil-square{else}fa fa-lg fa-fw fa-edit{/if}{literal}',
                        "_disabled"			: function (data) {
                            var inst = $.jstree.reference(data.reference),
                                obj = inst.get_node(data.reference);
                            if(inst.is_disabled(obj)) {
    				...
    				"remove" : {
    					"icon"				: '{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-x-circle{else}fa-lg fa-fw fa-times-circle{/if}{literal} text-danger',
                    ...
                    "manage-user" : {
                        ...
                        "icon"				: '{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-person{else}fa fa-lg fa-fw fa-user{/if}{literal}',
                        "_disabled"			: function (data) {
                            var inst = $.jstree.reference(data.reference),
                                obj = inst.get_node(data.reference);
                            if(inst.is_disabled(obj)) {
                    ...
                    "manage-group" : {
                        "icon"				: '{/literal}{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-people{else}fa fa-lg fa-fw fa-users{/if}{literal}',
                        "_disabled"			: function (data) {
                            var inst = $.jstree.reference(data.reference),
                                obj = inst.get_node(data.reference);
                            if(inst.is_disabled(obj)) {

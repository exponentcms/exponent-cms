...
<div class="module navigation manager-hierarchy expanding manage-site-map">
    ...
    <div id="navmanager-tabs" class="">
   	    <ul class="nav nav-tabs" role="tablist">
           	<li role="presentation" class="nav-item"><a href="#tab1" class="nav-link active" role="tab" data-bs-toggle="tab"><em>{'Site Map'|gettext}</em></a></li>
            {if $canManageStandalones}<li role="presentation" class="nav-item"><a href="#tab2" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Standalone Pages'|gettext}</em></a></li>{/if}
            {if $smarty.const.HANDLE_PAGE_REDIRECTION}<li role="presentation" class="nav-item"><a href="#tab3" class="nav-link" role="tab" data-bs-toggle="tab"><em>{'Page Redirection'|gettext}</em></a></li>{/if}
   	    </ul>
                            ...
                            {/if}
                                ...
                                <td>
                                    {if !empty($section->page_title)}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-type-h1{else}fas fa-fw fa-heading{/if}" title="{$section->page_title}"></i>
                                    {else}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-type-h1{else}fas fa-fw fa-heading{/if} text-warning" title="{'No page title'|gettext}"></i>
                                    {/if}
                                    {if !empty($section->description)}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-card-text{else}fas fa-fw fa-list-alt{/if}" title="{$section->description}"></i>
                                    {else}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-card-text{else}fas fa-fw fa-list-alt{/if} text-warning" title="{'No page description'|gettext}"></i>
                                    {/if}
                                    {if !empty($section->keywords)}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-list-ul{else}fas fa-fw fa-list-ul{/if}" title="{$section->keywords}"></i>
                                    {else}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-list-ul{else}fas fa-fw fa-list-ul{/if} text-warning" title="{'No page keywords'|gettext}"></i>
                                    {/if}
                                    {if $section->public}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-people{else}fas fa-fw fa-users{/if}" title="{'Public'|gettext}"></i>
                                    {else}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-file-lock{else}fas fa-fw fa-user-secret{/if} text-danger" title="{'Private'|gettext}"></i>
                                    {/if}
                                    {if $section->active}
                                    ...
                                    {else}
                                        <i class="{if $smarty.const.USE_BOOTSTRAP_ICONS}bi-file-arrow-down{else}fas fa-fw fa-arrow-down{/if}" title="{'Open in-place'|gettext}"></i>
                                    {/if}
...
{script unique="tabload" jquery="bootbox.all" bootstrap="modal,tab"}
{literal}
    $('.loadingdiv').remove();

...
<div id="navmanager" class="module navigation manager">
	...
	<div id="navmanager-tabs" class="yui-navset exp-skin-tabview hide">
	    ...
	    <div class="yui-content">
        	<div id="tab1">{exp_include file="`$smarty.const.BASE`framework/modules/navigation/views/navigation/manage_hierarchy.tpl"}</div>
	        {if $canManageStandalones}<div id="tab2">{exp_include file="`$smarty.const.BASE`framework/modules/navigation/views/navigation/manage_standalone.tpl"}</div>{/if}
	    </div>
	</div>

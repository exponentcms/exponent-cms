...
<div id="navmanager" class="module navigation manager">
	...
	<div id="navmanager-tabs" class="">
	    ...
	    <div class="tab-content">
        	<div id="tab1" role="tabpanel" class="tab-pane fade in active">{include file="`$smarty.const.BASE`framework/modules/navigation/views/navigation/manage_hierarchy.bootstrap3.tpl"}</div>

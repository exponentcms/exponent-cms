...
if ((isset($_POST['action']) ? $_POST['action'] : (isset($_GET['action']) ? $_GET['action'] : '')) == 'simple') {
    ...
    if ($handle->uploaded) {
        ...
        TestProcess($handle, 'watermark, automatic up-resizing activated', "\$foo->image_watermark       = '../../assets/images/watermark.png';\n\$foo->image_watermark_no_zoom_in = false;");

        // -----------
        $handle->image_watermark       = "../../assets/images/watermark_large.png";
        TestProcess($handle, 'large watermark automatically reduced (default)', "\$foo->image_watermark       = '../../assets/images/watermark_large.png';");

        // -----------
        $handle->image_watermark       = "../../assets/images/watermark_large.png";
        $handle->image_watermark_no_zoom_out = true;
        TestProcess($handle, 'large watermark, automatic down-resizing deactivated', "\$foo->image_watermark       = '../../assets/images/watermark_large.png';\n\$foo->image_watermark_no_zoom_out = true;");

        // -----------
        $handle->image_watermark       = "../../assets/images/watermark_large.png";
        $handle->image_watermark_no_zoom_out = true;
        $handle->image_watermark_position = 'TL';
        TestProcess($handle, 'large watermark, down-resizing deactivated, position top-left', "\$foo->image_watermark       = '../../assets/images/watermark_large.png';\n\$foo->image_watermark_no_zoom_out = true;\n\$foo->image_watermark_position = 'TL'");

        // -----------
        $handle->image_watermark       = "../../assets/images/watermark_large.png";
        $handle->image_watermark_x     = 20;
        $handle->image_watermark_y     = -20;
        TestProcess($handle, 'large watermark automatically reduced, position 20 -20', "\$foo->image_watermark       = '../../assets/images/watermark_large.png';\n\$foo->image_watermark_x     = 20;\n\$foo->image_watermark_y     = -20;");

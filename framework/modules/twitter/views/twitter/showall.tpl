				...
				<p>
					{if $config.showimage}
						<div style="float:left;">
							{img src="`$tweet.image`" style="margin:100% 5px 2px 0px;"}
					...
					{elseif $tweet.retweetedbyme}
						{img src="$smarty.const.URL_FULL|cat:'framework/modules/twitter/assets/images/tweeted.png'" style="float:left;margin:100% 5px 2px 0px;"}
					{/if}

...
//                    <a href="#" class="btn btn-default '.$btn_size.'" name=alpha' . $uniqueid . ' id=alpha' . $uniqueid . ' style="float:left;"><i class="fas fa-sort '.$icon_size.'"></i> ' . gt('Sort List Alphabetically') . '</a>
                $html .= '
                    <div id="sort' . $uniqueid . '" class="btn btn-default float-left"><i class="' . (USE_BOOTSTRAP_ICONS?'bi-sort-alpha-down':'fas fa-sort-alpha-asc') . ' ' . $icon_size . '"></i> ' . gt('Sort') . '</div>
                    <button type="submit" class="btn btn-primary"><i class="' . (USE_BOOTSTRAP_ICONS?'bi-save':'fas fa-floppy-o') . ' ' . $icon_size . '"></i> ' . gt('Save') . '</button>
                    </div>
                  </form>
                </div>
                </div>

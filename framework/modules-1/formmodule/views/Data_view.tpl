...
<div class="module-actions">
	{permissions}
		{if $permissions.viewdata == 1 && $form->is_saved == 1}<a class="addnew mngmntlink" href="{link _common=1 view='Default' action='show_view' module=formmodule id=$form->id}">{'Enter a Record'|gettext}</a>&nbsp;&nbsp;{/if}

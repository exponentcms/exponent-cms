...
{css unique="flyout-left" link="`$smarty.const.PATH_RELATIVE`framework/modules-1/containermodule/assets/css/flyoutleft.css"}

{/css}

<div class="module container flyout_left" style="display: none;">

{css unique="login" link="`$smarty.const.PATH_RELATIVE`framework/modules-1/loginmodule/assets/css/flyout.css"}

{/css}

{script unique="flyout" type="text/javascript" src="http://jqueryjs.googlecode.com/files/jquery-1.3.2.js"}
{literal}
...
<div class="loginmodule flyout panel">

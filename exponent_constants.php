...
if (USE_CDN) {
    ...
    if (!defined('FA6_SCRIPT')) {
        define('FA6_SCRIPT', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css');
...
if (!defined('SMARTY_PATH')) {
    if (version_compare(PHP_VERSION, '7.1.0', 'lt')) {
        ...
        define('SMARTY_VERSION', '4.1.1');  //note smarty v3.1.28+ won't work properly with php < v7.1+
    }
...
if (!defined('SWIFT_PATH')) {
     ...
     */
    define('EMAIL_VALIDATOR_VERSION', '3.2');
...
if (!defined('TCPDF5_VERSION')) {
    define('TCPDF5_VERSION', '6.3.5');  // 6.4.4
}

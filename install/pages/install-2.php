...
<form role="form" method="post" action="index.php">
	...
	<div class="control" id="mysql_options">
		...
		<div class="control">
			...
			<input class="text form-control" type="text" name="sc[db_host]" value="<?php echo $config['db_host']; ?>" required=1 />
			<div class="control_help">
		...
		<div class="control">
			...
			<input class="text form-control" type="text" name="sc[db_port]" value="<?php echo $config['db_port']; ?>" size="5" required=1 />
			<div class="control_help">
		...
		<div class="control">
			...
			<input class="text form-control" type="text" name="sc[db_name]" value="<?php echo $config['db_name']; ?>" required=1 />
		</div>
		<div class="control">
			<span class="label"><?php echo gt('Username'); ?>: </span>
			<input class="text form-control" type="text" name="sc[db_user]" value="<?php echo $config['db_user']; ?>" required=1 />
			<div class="control_help">
		...
		<div class="control">
			...
			<input class="text form-control" type="password" name="sc[db_pass]" value="<?php echo $config['db_pass']; ?>" required=1 />
			<div class="control_help">
		...
		<div class="control">
			...
			<input class="text form-control" type="text" name="sc[db_table_prefix]" value="<?php echo $config['db_table_prefix']; ?>" />
			<div class="control_help">

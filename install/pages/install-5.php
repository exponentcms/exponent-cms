...
if (is_readable(BASE . 'themes')) {
    ...
    while (($file = readdir($dh)) !== false) {
        if ($file != '.' && $file != '..' && is_dir(BASE . "themes/$file") && is_readable(
            ...
            echo is_readable(BASE . "themes/$file/preview.jpg") ?
                "<img class=\"themepreview\" src=\"" . PATH_RELATIVE . "thumb.php?&amp;src=" . PATH_RELATIVE . "themes/$file/preview.jpg&amp;w=100&amp;q=75\">" :
                "<img src=\"" . PATH_RELATIVE . "thumb.php?src=" . YUI2_RELATIVE . "yui2-skin-sam-editor/assets/skins/sam/blankimage.png&amp;w=100&amp;q=75\" class=\"themepreview\">";

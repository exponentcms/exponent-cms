...
if (is_readable(BASE . 'themes')) {
    ...
    while (($file = readdir($dh)) !== false) {
        if (is_readable(BASE . "themes/$file/class.php")) {
			...
			echo file_exists(BASE . "themes/$file/sample.eql") ? '<input type="checkbox" name="install_sample" value="1" checked="checked" class="checkbox"><label class="label ">Install Sample Content</label><br /><br />' : '';

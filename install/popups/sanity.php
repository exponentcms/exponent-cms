...
<tr>
	<td id="fdp_conf-configphp" class="bodytext" style="font-weight: bold;">framework/conf/config.php <br /> framework/conf/profiles <br /> overrides.php
...
<tr>
	<td id="o_db" class="bodytext" style="font-weight: bold;" width="25%"><?php echo gt('Database Backend'); ?></td>
	<td class="bodytext">
...
<tr>
	<td id="o_gd" class="bodytext" style="font-weight: bold;"><?php echo gt('GD Graphics Library'); ?></td>
	<td class="bodytext">
...
<tr>
	<td id="o_php" class="bodytext" style="font-weight: bold;">PHP 5.6.0+</td>
	<td class="bodytext">
		<?php echo gt('Because of some of the functions that Exponent uses, versions of PHP prior to 5.6.0 are not suitable.  Most functions that are supported in later versions have workarounds, but there are a few major bugs, and functions that can\'t be re-implemented in PHP prior to 5.6.0.'); ?>
	</td>
</tr>
<tr>
	<td id="o_zlib" class="bodytext" style="font-weight: bold;"><?php echo gt('ZLib Support'); ?></td>
	<td class="bodytext">
...
<tr>
	<td id="o_xml" class="bodytext" style="font-weight: bold;"><?php echo gt('XML (Expat) Library Support'); ?></td>
	<td class="bodytext">
...
<tr>
	<td id="o_curl" class="bodytext" style="font-weight: bold;"><?php echo gt('FileInfo Support'); ?></td>
	<td class="bodytext">
...
<tr>
	<td id="o_upload" class="bodytext" style="font-weight: bold;"><?php echo gt('File Uploads Enabled'); ?></td>
	<td class="bodytext">
...
<tr>
	<td id="o_tmpfile" class="bodytext" style="font-weight: bold;"><?php echo gt('Temporary File Creation'); ?></td>
	<td class="bodytext">

...
class bootstrap3theme extends theme {
	...
	function description() {
        ...
        $ret = "An HTML5 responsive grids theme based on <a href=\"https://getbootstrap.com/docs/3.4/\" target=\"_blank\">Twitter Bootstrap v3</a> and <a href=\"https://fontawesome.com/v4.7.0/\" target=\"_blank\">Font Awesome v4</a>";
    ...
    function configureTheme() {
       	...
       	if (is_readable(BASE.'external/bootstrap3/less')) {
       		...
       		while (($file = readdir($dh)) !== false) {
       			if ($file !== '.' && $file !== '..' && is_dir(BASE."external/bootstrap3/less/$file")) {
                    if ($file !== 'mixins' && $file !== 'fonts' && $file !== 'help')
        ...
        $form->register('enhanced_style',gt('Add Bootstrap v2 Style Effects'),new checkboxcontrol((!empty($settings['ENHANCED_STYLE']))));
        ...
        $form->register('flyout_sidebar',gt('Enable Sidebar Flyout Container'),new checkboxcontrol((!empty($settings['FLYOUT_SIDEBAR']))));

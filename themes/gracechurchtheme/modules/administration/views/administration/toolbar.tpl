...
//        $('body').css('margin-top', $('#admin-toolbar').height()+10);
    ...
    $(document).ready(function(){
        if ({/literal}{$top}{literal}) {  // fixed top menu
            //$(document.body).css('margin-top', $('#admin-toolbar').outerHeight() + $('#topnavbar').outerHeight());
            $(document.body).css('margin-top', $('#admin-toolbar').outerHeight());
            $(document.body).css('margin-bottom', 0);
            $('#topnavbar div.navbar-header').outerHeight($('#nav_text').outerHeight() + 13)

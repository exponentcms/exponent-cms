...
if (class_exists('seiba_bs3theme')) return;

class seiba_bs3theme extends theme {
    public $user_configured = true;
    public $stock_theme = false;

	function name() { return "SEIBA Twitter Bootstrap 3 Theme"; }
...
//        $form->register('menu_location',gt('Menu Location').': ',new dropdowncontrol($settings['MENU_LOCATION'],$menu_locations));
    ...
    function saveThemeConfig ($params) {
        ...
        $params['menu_location'] = 'static-top';

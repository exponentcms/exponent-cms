...
<div id="doc">
  ...
  <div id="bd" class="yui3-g">
    <div id="centercol-vehicles" class="yui3-u-3-4">
      <div class="content-vehicles">
             <?php expTheme::module(array("controller"=>"container","action"=>"showall","view"=>"showall","source"=>"@page","scope"=>"sectional")); ?>	
        				...
        				<?php require ("vehicles_menu.html"); ?><br />
        <div>
          <?php expTheme::main(); ?><?php include ("eucookie.php"); ?>
        </div>
        <div>
          <?php expTheme::Module(array("controller"=>"container","action"=>"showall","view"=>"showall_vehicles-test","source"=>"@vehicles-test","scope"=>"sectional")); ?>
          <p>&nbsp;</p>
          <div class="clear"></div>
...
<script type="text/javascript" language="javascript" src="<?php echo THEME_RELATIVE?>js/sorttable.js"></script>
...
YUI.add('SimpleAjaxUploader', function (Y) {
  ...
  Y.ss = Y.ss || {};
    ...
    Y.ss.removeEvent = document.removeEventListener ?
    ...
    Y.ss.encodeUTF8 = function( str ) {
        "use strict";
        /*jshint nonstandard:true*/
        return unescape( encodeURIComponent( str ) );
    };

    Y.ss.getIFrame = function() {
        "use strict";
    ...
    Y.ss.getHidden = function( name, value ) {
        "use strict";
    ...
    Y.ss.parseJSON = function( data ) {
        ...
        return data && !Y.ss.trim( data.replace( rvalidtokens, function( token, comma, open, close ) {
    ...
    Y.ss.isVisible = function( elem ) {
        ...
        if ( elem.offsetWidth > 0 ||
            elem.offsetHeight > 0 ||
            Y.ss.getStyle( elem, 'display' ).toLowerCase() != 'none' )
        {
            return Y.ss.isVisible( elem.parentNode );
        }
    ...
    Y.ss.getStyle = function( elem, style ) {
        "use strict";
    ...
    Y.ss.getFormObj = function( form ) {
        ...
        for ( var i = 0, len = elems.length; i < len; i++ ) {
            ...
            if ( elems[ i ].name && !elems[ i ].disabled && Y.ss.indexOf( ignore, elems[ i ].type ) === -1 ) {
                ...
                obj[ elems[ i ].name ] = Y.ss.val( elems[ i ] );
                Y.ss.extendObj( inputs, obj );
            }
        }
    ...
    Y.ss.uploadSetup = function( options ) {
        "use strict";
        Y.ss.extendObj( Y.ss._options, options );
    };
    ...
    Y.ss.SimpleUpload = function( options ) {
        ...
        Y.ss.extendObj( this._opts, Y.ss._options ); // Include any setup options
        Y.ss.extendObj( this._opts, options ); // Then add options for this instance
    ...
    Y.ss.SimpleUpload.prototype = {
        ...
        addDZ: function( dropzone ) {
            ...
            dropzone = Y.ss.verifyElem( dropzone );
        ...
        setForm: function( form ) {
            ...
            this._form = Y.ss.verifyElem( form );
            ...
            if ( !this._form || this._form.nodeName.toUpperCase() != 'FORM' ) {
                ...
                if ( this._opts.overrideSubmit ) {
                    Y.ss.addEvent( this._form, 'submit', function( e ) {
                        if ( e.preventDefault ) {
                            e.preventDefault();
        ...
        updatePosition: function( btn ) {
            ...
            if ( btn && this._input && this._input.parentNode ) {
                Y.ss.copyLayout( btn, this._input.parentNode );
            }
        ...
        rerouteClicks: function( elem ) {
            ...
            if ( self._opts.autoCalibrate && !Y.ss.isVisible( elem ) ) {
                self.log('Upload button not visible');

                var interval = function() {
                    if ( Y.ss.isVisible( elem ) ) {
    ...
    Y.ss.IframeUpload = {
        ...
        _addFiles: function( file ) {
            var filename = Y.ss.getFilename( file.value ),
        ...
        _uploadIframe: function( fileObj, progBox, sizeBox, progBar, pctBox, abortBtn, removeAbort ) {
            ...
            if ( opts.cors ) {
                var msgId = Y.ss.getUID();

                self._detachEvents[ msgId ] = Y.ss.addEvent( window, 'message', function( event ) {
            ...
            self._detachEvents[ iframe.id ] = Y.ss.addEvent( iframe, 'load', function() {
                self._detach( iframe.id );

                if ( opts.sessionProgressUrl ) {
                    form.appendChild( Y.ss.getHidden( opts.sessionProgressName, key ) );
                }

                // PHP APC upload progress key field must come before the file field
                else if ( opts.progressUrl ) {
                    form.appendChild( Y.ss.getHidden( opts.keyParamName, key ) );
                }

                if ( self._form ) {
                    Y.ss.extendObj( opts.data, Y.ss.getFormObj( self._form ) );
                }

                // Get additional data after startNonXHR() in case setData() was called prior to submitting
                for ( var prop in opts.data ) {
                    if ( opts.data.hasOwnProperty( prop ) ) {
                        form.appendChild( Y.ss.getHidden( prop, opts.data[prop] ) );
                    }
                }
                ...
                if ( opts.cors ) {
                    form.appendChild( Y.ss.getHidden( opts.corsInputName, window.location.href ) );
                }

                form.appendChild( fileObj.file );

                self._detachEvents[ fileObj.id ] = Y.ss.addEvent( iframe, 'load', function() {
        ...
        _getProg: function( key, progBar, sizeBox, pctBox, counter ) {
            ...
            if ( opts.cors && !opts.sessionProgressUrl ) {
                ...
                Y.ss.extendObj( headers, opts.customProgressHeaders );

                for ( var i in headers ) {
                    if ( headers.hasOwnProperty( i ) ) {
                        if ( opts.encodeHeaders ) {
                            xhr.setRequestHeader( i, Y.ss.encodeUTF8( headers[ i ] + '' ) );
    ...
    Y.ss.XhrUpload = {
        ...
        _addFiles: function( files ) {
            ...
            for ( i = 0; i < total; i++ ) {
                filename = Y.ss.getFilename( files[i].name );
                ext = Y.ss.getExt( filename );
        ...
        _uploadXhr: function( fileObj, url, params, headers, sizeBox, progBar, progBox, pctBox, abortBtn, removeAbort ) {
            ...
            Y.ss.extendObj( headers, opts.customHeaders );
        ...
        _initUpload: function( fileObj ) {
            ...
            if ( this._form ) {
                Y.ss.extendObj( params, Y.ss.getFormObj( this._form ) );
            }

            // We get the any additional data here after startXHR()
            Y.ss.extendObj( params, this._opts.data );

            // Build query string while preserving any existing parameters
            url = this._opts.noParams === true ?
                this._opts.url :
            this._opts.url + ( ( this._opts.url.indexOf( '?' ) > -1 ) ? '&' : '?' ) + Y.ss.obj2string( params );
    ...
    Y.ss.DragAndDrop = {
        ...
        addDropZone: function( elem ) {
            ...
            elem.ondragenter = function( e ) {
                ...
                Y.ss.addClass( this, self._opts.dragClass );
                depthCounter++;
                return false;
            };
            ...
            elem.ondragend = function() {
                Y.ss.removeClass( this, self._opts.dragClass );
                return false;
            };
    ...
    Y.ss.extendObj( Y.ss.SimpleUpload.prototype, {
        ...
        _createInput: function() {
            ...
            this._input.turnOff = Y.ss.addEvent( this._input, 'change', function() {
            ...
            if ( self._opts.hoverClass !== '' ) {
                div.mouseOverOff = Y.ss.addEvent( div, 'mouseover', function() {
                    Y.ss.addClass( self._overBtn, self._opts.hoverClass );
                });
            }

            div.mouseOutOff = Y.ss.addEvent( div, 'mouseout', function() {
                self._input.parentNode.style.visibility = 'hidden';
            ...
            if ( self._opts.focusClass !== '' ) {
                this._input.focusOff = Y.ss.addEvent( this._input, 'focus', function() {
                    Y.ss.addClass( self._overBtn, self._opts.focusClass );
                });

                this._input.blurOff = Y.ss.addEvent( this._input, 'blur', function() {
                    Y.ss.removeClass( self._overBtn, self._opts.focusClass );
                });
            }
    ...
    if ( XhrOk ) {
        Y.ss.extendObj( Y.ss.SimpleUpload.prototype, Y.ss.XhrUpload );

    } else {
        Y.ss.extendObj( Y.ss.SimpleUpload.prototype, Y.ss.IframeUpload );
    }

    Y.ss.extendObj( Y.ss.SimpleUpload.prototype, Y.ss.DragAndDrop );

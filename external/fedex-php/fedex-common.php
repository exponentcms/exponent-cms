...
//define('TRANSACTIONS_LOG_FILE', BASE.'tmp/fedextransactions.log');  // Transactions log file
define('TRANSACTIONS_LOG_FILE', BASE.'tmp/fedextransactions.log');
...
function getProperty($var){
	...
	if($var == 'dutyaccount') Return '510087968';
	if($var == 'accounttovalidate') Return '510087968';
	if($var == 'meter') Return '100047671';
	if($var == 'key') Return 'Y2NjGlXrEEz6PyRo';
	if($var == 'password') Return 'TazmS0qIesz3NhlahrIQAbPPA';
